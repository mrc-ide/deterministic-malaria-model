...
vivax_model_ <- R6::R6Class(
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "vivax_model_rhs_dde",
      rhs_desolve = "vivax_model_rhs_desolve",
      initmod_desolve = "vivax_model_initmod_desolve",
      output_dde = "vivax_model_output_dde"),
    dll = "ICDMM",
    user = c("A_D_50pc", "A_LM_50pc", "A_PCR_50pc", "age", "age_20_factor",
             "age_rate", "age05", "age20l", "age20u", "age59", "b", "betaL",
             "bites_Bed", "bites_Indoors", "cD", "chi", "cLM", "cPCR", "cT",
             "d_clin", "d_IRS0", "d_ITN0", "d_mat", "d_par", "dE", "dEL",
             "delayMos", "den", "dLL", "dPCR_max", "dPCR_min", "dPL", "eta",
             "ff", "foi_age", "ft", "gamma_L", "gammaL", "het_wt",
             "hypnozoite_prev_threshold", "init_AC", "init_AP", "init_EL",
             "init_Ev", "init_Hyp", "init_I_D", "init_I_LM", "init_I_PCR",
             "init_Iv", "init_LL", "init_P", "init_PL", "init_S", "init_Sv",
             "init_T", "irs_cov", "IRS_interval", "irs_loss", "itn_cov",
             "ITN_interval", "ITN_IRS_on", "itn_loss", "K_D", "K_LM",
             "K_max_switch", "K_max_switch_on", "K_PCR", "K0_switch", "kk",
             "mu0", "muEL", "muLL", "muPL", "mv0", "na", "nh", "nk",
             "num_int", "omega", "p_mat", "p10", "p2", "phi_D_max",
             "phi_D_min", "phi_LM_max", "phi_LM_min", "pi", "Q0", "r_IRS0",
             "r_ITN0", "r_ITN1", "rD", "rel_foi", "rLM", "rP", "rT", "ssa0",
             "ssa1", "ssa2", "ssa3", "ssb1", "ssb2", "ssb3",
             "stop_rebound_switch", "tau1", "tau2", "theta_c", "u_clin",
             "u_par"),
    ...
    registration = function() {
      if (FALSE) {
        .C("vivax_model_rhs_dde", package = "ICDMM")
        .C("vivax_model_rhs_desolve", package = "ICDMM")
        .C("vivax_model_initmod_desolve", package = "ICDMM")
        .C("vivax_model_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("vivax_model_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("vivax_model_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("vivax_model_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/vivax_model.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("vivax_model_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("vivax_model_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("vivax_model_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("vivax_model_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
vivax_model <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("vivax_model")
  vivax_model_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(vivax_model) <- "odin_generator"
attr(vivax_model, "generator") <- vivax_model_
