...
mosquito_larval_model_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "mosquito_larval_model_rhs_dde",
      rhs_desolve = "mosquito_larval_model_rhs_desolve",
      initmod_desolve = "mosquito_larval_model_initmod_desolve",
      output_dde = "mosquito_larval_model_output_dde"),
    dll = "ICDMM",
    ...
    registration = function() {
      if (FALSE) {
        .C("mosquito_larval_model_rhs_dde", package = "ICDMM")
        .C("mosquito_larval_model_rhs_desolve", package = "ICDMM")
        .C("mosquito_larval_model_initmod_desolve", package = "ICDMM")
        .C("mosquito_larval_model_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("mosquito_larval_model_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("mosquito_larval_model_metadata", private$ptr,
                    PACKAGE = "ICDMM")
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("mosquito_larval_model_create", user, PACKAGE = "ICDMM")
    ...
    ir = function() {
      path_ir <- system.file("odin/mosquito_larval_model.json", mustWork = TRUE,
                             package = "ICDMM")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("mosquito_larval_model_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("mosquito_larval_model_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("mosquito_larval_model_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("mosquito_larval_model_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
mosquito_larval_model <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("mosquito_larval_model")
  mosquito_larval_model_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(mosquito_larval_model) <- "odin_generator"
attr(mosquito_larval_model, "generator") <- mosquito_larval_model_
