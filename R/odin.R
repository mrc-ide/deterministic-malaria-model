...
odin_model_ <- R6::R6Class(
  ...
  private = list(
    ...
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             ...
             "d1", "dB", "dCA", "dE", "dEL", "delayGam", "delayMos", "den",
             "dID", "dLL", "dPL", "eta", "fD0", "foi_age", "ft", "gamma1",
             "gammaD", "gammaL", "het_wt", "IB0", "IC0", "ICM_age", "ID0",
             ...
             "PM", "Q0", "r_IRS0", "r_ITN0", "r_ITN1", "rA", "rD", "rel_foi",
             "rP", "rT", "rU", "ssa0", "ssa1", "ssa2", "ssa3", "ssb1",
             "ssb2", "ssb3", "tau1", "tau2", "theta_c", "uB", "uCA", "uD",
             "x_I"),
