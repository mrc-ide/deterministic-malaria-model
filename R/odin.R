...
odin_model_experimentation_ <- R6::R6Class(
  ...
  private = list(
    ...
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             ...
             "delayMos", "den", "dID", "dLL", "dPL", "EIR_diff",
             "EIR_diff_on", "eta", "fD0", "foi_age", "FOI_proportion",
             "FOI_proportion_on", "ft", "gamma1", "gammaD", "gammaL",
             "het_wt", "IB0", "IC0", "ID0", "init_A", "init_D", "init_EIR",
             ...
             "kB", "kC", "kD", "larvacide_on", "larval_factor", "mu0",
