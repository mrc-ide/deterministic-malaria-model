...
ivm_model_fit_mort_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "ivm_model_fit_mort_rhs_dde",
      rhs_desolve = "ivm_model_fit_mort_rhs_desolve",
      initmod_desolve = "ivm_model_fit_mort_initmod_desolve",
      output_dde = "ivm_model_fit_mort_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             ...
             "gamma_c_0", "gamma_c_min_age", "gamma_h_0", "gamma_h_min_age",
             "gamma1", "gammaD", "gammaL", "haz_c0", "het_wt", "IB0", "IC0",
             ...
             "ITN_interval", "ITN_IRS_on", "itn_loss", "ivm_c_on",
             "ivm_h_on", "kB", "kC", "kD", "mu0", "muEL", "muLL", "muPL",
             "mv0", "na", "nh", "num_int", "omega", "p10", "p2", "phi0",
    ...
    registration = function() {
      if (FALSE) {
        .C("ivm_model_fit_mort_rhs_dde", package = "ICDMM")
        .C("ivm_model_fit_mort_rhs_desolve", package = "ICDMM")
        .C("ivm_model_fit_mort_initmod_desolve", package = "ICDMM")
        .C("ivm_model_fit_mort_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("ivm_model_fit_mort_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("ivm_model_fit_mort_metadata", private$ptr,
                    PACKAGE = "ICDMM")
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("ivm_model_fit_mort_create", user, PACKAGE = "ICDMM")
    ...
    ir = function() {
      path_ir <- system.file("odin/ivm_model_fit_mort.json", mustWork = TRUE,
                             package = "ICDMM")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("ivm_model_fit_mort_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("ivm_model_fit_mort_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("ivm_model_fit_mort_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("ivm_model_fit_mort_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
ivm_model_fit_mort <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("ivm_model_fit_mort")
  ivm_model_fit_mort_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(ivm_model_fit_mort) <- "odin_generator"
attr(ivm_model_fit_mort, "generator") <- ivm_model_fit_mort_
mosquito_ivermectin_model_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "mosquito_ivermectin_model_rhs_dde",
      rhs_desolve = "mosquito_ivermectin_model_rhs_desolve",
      initmod_desolve = "mosquito_ivermectin_model_initmod_desolve",
      output_dde = "mosquito_ivermectin_model_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "b0", "b1", "betaL", "bites_Bed",
             "bites_Indoors", "cD", "chi", "cT", "cU", "d_IRS0", "d_ITN0",
             ...
             "ITN_IRS_on", "itn_loss", "ivm_c_on", "ivm_h_on", "kB", "kC",
             "kD", "mu_c_0", "mu_h_0", "mu0", "muEL", "muLL", "muPL", "mv0",
             "na", "nh", "num_int", "omega", "p10", "p2", "phi0", "phi1",
             "pi", "PM", "Q0", "r_IRS0", "r_ITN0", "r_ITN1", "rA", "rD",
             "rel_foi", "rP", "rT", "rU", "ssa0", "ssa1", "ssa2", "ssa3",
             "ssb1", "ssb2", "ssb3", "tau1", "tau2", "theta_c", "uB", "uCA",
             "uD", "x_I"),
    ...
    registration = function() {
      if (FALSE) {
        .C("mosquito_ivermectin_model_rhs_dde", package = "ICDMM")
        .C("mosquito_ivermectin_model_rhs_desolve", package = "ICDMM")
        .C("mosquito_ivermectin_model_initmod_desolve", package = "ICDMM")
        .C("mosquito_ivermectin_model_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("mosquito_ivermectin_model_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("mosquito_ivermectin_model_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("mosquito_ivermectin_model_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/mosquito_ivermectin_model.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("mosquito_ivermectin_model_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("mosquito_ivermectin_model_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("mosquito_ivermectin_model_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("mosquito_ivermectin_model_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
mosquito_ivermectin_model <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("mosquito_ivermectin_model")
  mosquito_ivermectin_model_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
...
mosquito_ivermectin_model_no_delay_ <- R6::R6Class(
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "mosquito_ivermectin_model_no_delay_rhs_dde",
      rhs_desolve = "mosquito_ivermectin_model_no_delay_rhs_desolve",
      initmod_desolve = "mosquito_ivermectin_model_no_delay_initmod_desolve",
      output_dde = "mosquito_ivermectin_model_no_delay_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "b0", "b1", "betaL", "bites_Bed",
             "bites_Indoors", "cD", "chi", "cT", "cU", "d_IRS0", "d_ITN0",
             "d1", "dB", "dCA", "dCM", "dE", "dEL", "delayGam", "delayMos",
             "den", "dID", "dLL", "dPL", "eta", "fD0", "foi_age", "ft",
             "gamma_c", "gamma_h", "gamma1", "gammaD", "gammaL", "het_wt",
    ...
    registration = function() {
      if (FALSE) {
        .C("mosquito_ivermectin_model_no_delay_rhs_dde", package = "ICDMM")
        .C("mosquito_ivermectin_model_no_delay_rhs_desolve", package = "ICDMM")
        .C("mosquito_ivermectin_model_no_delay_initmod_desolve", package = "ICDMM")
        .C("mosquito_ivermectin_model_no_delay_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("mosquito_ivermectin_model_no_delay_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("mosquito_ivermectin_model_no_delay_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("mosquito_ivermectin_model_no_delay_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/mosquito_ivermectin_model_no_delay.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("mosquito_ivermectin_model_no_delay_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("mosquito_ivermectin_model_no_delay_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("mosquito_ivermectin_model_no_delay_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("mosquito_ivermectin_model_no_delay_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
mosquito_ivermectin_model_no_delay <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("mosquito_ivermectin_model_no_delay")
  mosquito_ivermectin_model_no_delay_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(mosquito_ivermectin_model_no_delay) <- "odin_generator"
attr(mosquito_ivermectin_model_no_delay, "generator") <- mosquito_ivermectin_model_no_delay_
...
odin_model_IVM_SMChet_nilani_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_IVM_SMChet_nilani_rhs_dde",
      rhs_desolve = "odin_model_IVM_SMChet_nilani_rhs_desolve",
      initmod_desolve = "odin_model_IVM_SMChet_nilani_initmod_desolve",
      output_dde = "odin_model_IVM_SMChet_nilani_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_rate", "age02", "age05", "age10", "age59",
             "b0", "b1", "B2", "betaL", "bites_Bed", "bites_Indoors", "ccov",
             "cD", "chi", "cT", "cU", "d_IRS0", "d_ITN0", "d1", "dB", "dCA",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_IVM_SMChet_nilani_rhs_dde", package = "ICDMM")
        .C("odin_model_IVM_SMChet_nilani_rhs_desolve", package = "ICDMM")
        .C("odin_model_IVM_SMChet_nilani_initmod_desolve", package = "ICDMM")
        .C("odin_model_IVM_SMChet_nilani_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_IVM_SMChet_nilani_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_IVM_SMChet_nilani_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_IVM_SMChet_nilani_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_IVM_SMChet_nilani.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_IVM_SMChet_nilani_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_IVM_SMChet_nilani_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_IVM_SMChet_nilani_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_IVM_SMChet_nilani_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_IVM_SMChet_nilani <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("odin_model_IVM_SMChet_nilani")
  odin_model_IVM_SMChet_nilani_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_IVM_SMChet_nilani) <- "odin_generator"
attr(odin_model_IVM_SMChet_nilani, "generator") <- odin_model_IVM_SMChet_nilani_
odin_model_mort_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_mort_rhs_dde",
      rhs_desolve = "odin_model_mort_rhs_desolve",
      initmod_desolve = "odin_model_mort_initmod_desolve",
      output_dde = "odin_model_mort_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "b0", "b1", "betaL", "bites_Bed",
             "bites_Indoors", "cD", "chi", "cT", "cU", "d_IRS0", "d_ITN0",
             ...
             "init_PL", "init_S", "init_Sv", "init_T", "init_U", "irs_cov",
             "IRS_interval", "irs_loss", "itn_cov", "ITN_interval",
             "ITN_IRS_on", "itn_loss", "kB", "kC", "kD", "mort_off",
             "mort_on", "mu0", "muEL", "muLL", "muPL", "mv0", "na", "nh",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_mort_rhs_dde", package = "ICDMM")
        .C("odin_model_mort_rhs_desolve", package = "ICDMM")
        .C("odin_model_mort_initmod_desolve", package = "ICDMM")
        .C("odin_model_mort_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_mort_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_mort_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_mort_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_mort.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_mort_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_mort_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_mort_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_mort_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_mort <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("odin_model_mort")
  odin_model_mort_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_mort) <- "odin_generator"
attr(odin_model_mort, "generator") <- odin_model_mort_
odin_model_mort_bad_betaa_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_mort_bad_betaa_rhs_dde",
      rhs_desolve = "odin_model_mort_bad_betaa_rhs_desolve",
      initmod_desolve = "odin_model_mort_bad_betaa_initmod_desolve",
      output_dde = "odin_model_mort_bad_betaa_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "b0", "b1", "betaL", "bites_Bed",
             "bites_Indoors", "cD", "chi", "cT", "cU", "d_IRS0", "d_ITN0",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_mort_bad_betaa_rhs_dde", package = "ICDMM")
        .C("odin_model_mort_bad_betaa_rhs_desolve", package = "ICDMM")
        .C("odin_model_mort_bad_betaa_initmod_desolve", package = "ICDMM")
        .C("odin_model_mort_bad_betaa_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_mort_bad_betaa_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_mort_bad_betaa_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_mort_bad_betaa_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_mort_bad_betaa.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_mort_bad_betaa_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_mort_bad_betaa_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_mort_bad_betaa_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_mort_bad_betaa_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_mort_bad_betaa <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("odin_model_mort_bad_betaa")
  odin_model_mort_bad_betaa_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_mort_bad_betaa) <- "odin_generator"
attr(odin_model_mort_bad_betaa, "generator") <- odin_model_mort_bad_betaa_
odin_model_no_delay_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_no_delay_rhs_dde",
      rhs_desolve = "odin_model_no_delay_rhs_desolve",
      initmod_desolve = "odin_model_no_delay_initmod_desolve",
      output_dde = "odin_model_no_delay_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "b0", "b1", "betaL", "bites_Bed",
             "bites_Indoors", "cD", "chi", "cT", "cU", "d_IRS0", "d_ITN0",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_no_delay_rhs_dde", package = "ICDMM")
        .C("odin_model_no_delay_rhs_desolve", package = "ICDMM")
        .C("odin_model_no_delay_initmod_desolve", package = "ICDMM")
        .C("odin_model_no_delay_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_no_delay_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_no_delay_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_no_delay_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_no_delay.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_no_delay_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_no_delay_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_no_delay_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_no_delay_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_no_delay <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("odin_model_no_delay")
  odin_model_no_delay_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_no_delay) <- "odin_generator"
attr(odin_model_no_delay, "generator") <- odin_model_no_delay_
