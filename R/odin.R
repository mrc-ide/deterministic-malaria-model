...
odin_model_experimentation_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_experimentation_rhs_dde",
      rhs_desolve = "odin_model_experimentation_rhs_desolve",
      initmod_desolve = "odin_model_experimentation_initmod_desolve",
      output_dde = "odin_model_experimentation_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             ...
             "FOI_diff", "FOI_diff_on", "FOI_proportion",
             "FOI_proportion_on", "ft", "gamma1", "gammaD", "gammaL",
             "het_wt", "IB0", "IC0", "ID0", "init_A", "init_D", "init_EL",
             "init_Ev", "init_IB", "init_ICA", "init_ICM", "init_ID",
             "init_Iv", "init_LL", "init_P", "init_PL", "init_S", "init_Sv",
             "init_T", "init_U", "irs_cov", "IRS_interval", "irs_loss",
             "itn_cov", "ITN_interval", "ITN_IRS_on", "itn_loss", "kB", "kC",
             "kD", "larvacide_on", "larval_factor", "mu0", "muEL", "muLL",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_experimentation_rhs_dde", package = "ICDMM")
        .C("odin_model_experimentation_rhs_desolve", package = "ICDMM")
        .C("odin_model_experimentation_initmod_desolve", package = "ICDMM")
        .C("odin_model_experimentation_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_experimentation_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_experimentation_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_experimentation_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_experimentation.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_experimentation_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_experimentation_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_experimentation_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_experimentation_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_experimentation <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("odin_model_experimentation")
  odin_model_experimentation_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_experimentation) <- "odin_generator"
attr(odin_model_experimentation, "generator") <- odin_model_experimentation_
