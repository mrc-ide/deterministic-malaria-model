## Automatically generated by odin 1.1.12 - do not edit
...
odin_model_ageprev_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_ageprev_rhs_dde",
      rhs_desolve = "odin_model_ageprev_rhs_desolve",
      initmod_desolve = "odin_model_ageprev_initmod_desolve",
      output_dde = "odin_model_ageprev_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "ageend", "agestart", "b0", "b1", "betaL",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_ageprev_rhs_dde", package = "ICDMM")
        .C("odin_model_ageprev_rhs_desolve", package = "ICDMM")
        .C("odin_model_ageprev_initmod_desolve", package = "ICDMM")
        .C("odin_model_ageprev_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_ageprev_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_ageprev_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_ageprev_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_ageprev.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_ageprev_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_ageprev_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_ageprev_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_ageprev_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_ageprev <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  odin_model_ageprev_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_ageprev) <- "odin_generator"
attr(odin_model_ageprev, "generator") <- odin_model_ageprev_
...
odin_model_m_immunity_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_m_immunity_rhs_dde",
      rhs_desolve = "odin_model_m_immunity_rhs_desolve",
      initmod_desolve = "odin_model_m_immunity_initmod_desolve",
      output_dde = "odin_model_m_immunity_output_dde"),
    dll = "ICDMM",
    user = c("aD", "age", "age_20_factor", "age_rate", "age05", "age20l",
             "age20u", "age59", "ageend", "agestart", "b0", "b1", "betaL",
             "bites_Bed", "bites_Indoors", "cD", "chi", "cT", "cU", "d_IRS0",
             "d_ITN0", "d1", "dB", "dCA", "dE", "dEL", "delayGam",
             "delayMos", "den", "dID", "dLL", "dPL", "eta", "fD0", "foi_age",
             "ft", "gamma1", "gammaD", "gammaL", "het_wt", "IB0", "IC0",
             "ICM_age", "ID0", "init_A", "init_D", "init_EL", "init_Ev",
             "init_IB", "init_ICA", "init_ID", "init_Iv", "init_LL",
             "init_P", "init_PL", "init_S", "init_Sv", "init_T", "init_U",
             "irs_cov", "IRS_interval", "irs_loss", "itn_cov",
             "ITN_interval", "ITN_IRS_on", "itn_loss", "kB", "kC", "kD",
             "mu0", "muEL", "muLL", "muPL", "mv0", "na", "nh", "num_int",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_m_immunity_rhs_dde", package = "ICDMM")
        .C("odin_model_m_immunity_rhs_desolve", package = "ICDMM")
        .C("odin_model_m_immunity_initmod_desolve", package = "ICDMM")
        .C("odin_model_m_immunity_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_m_immunity_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_m_immunity_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_m_immunity_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_m_immunity.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_m_immunity_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_m_immunity_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_m_immunity_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_m_immunity_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_m_immunity <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  odin_model_m_immunity_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_m_immunity) <- "odin_generator"
attr(odin_model_m_immunity, "generator") <- odin_model_m_immunity_
