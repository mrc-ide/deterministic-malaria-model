...
odin_model_human_ <- R6::R6Class(
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "odin_model_human_rhs_dde",
      rhs_desolve = "odin_model_human_rhs_desolve",
    ...
    registration = function() {
      if (FALSE) {
        .C("odin_model_human_rhs_dde", package = "ICDMM")
        .C("odin_model_human_rhs_desolve", package = "ICDMM")
        .C("odin_model_human_initmod_desolve", package = "ICDMM")
        .C("odin_model_human_output_dde", package = "ICDMM")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("odin_model_human_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "ICDMM")
    },

    update_metadata = function() {
      meta <- .Call("odin_model_human_metadata", private$ptr,
                    PACKAGE = "ICDMM")
      private$variable_order <- meta$variable_order
      private$output_order <- meta$output_order
      private$n_out <- meta$n_out
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("odin_model_human_create", user, PACKAGE = "ICDMM")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    ir = function() {
      path_ir <- system.file("odin/odin_model_human.json", mustWork = TRUE,
                             package = "ICDMM")
      json <- readLines(path_ir)
      class(json) <- "json"
      json
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("odin_model_human_set_user", private$ptr, user, PACKAGE = "ICDMM")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("odin_model_human_initial_conditions", private$ptr, t, PACKAGE = "ICDMM")
    },

    rhs = function(t, y) {
      .Call("odin_model_human_rhs_r", private$ptr, t, y, PACKAGE = "ICDMM")
    },
    ...
    contents = function() {
      .Call("odin_model_human_contents", private$ptr, PACKAGE = "ICDMM")
    },
...
odin_model_human <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  odin_model_human_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(odin_model_human) <- "odin_generator"
attr(odin_model_human, "generator") <- odin_model_human_
