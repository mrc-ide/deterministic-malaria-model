...
SEXP odin_model_emanators_create(SEXP user) {
  ...
  internal->offset_output_av_mosq = 28 + internal->dim_whi + internal->dim_zhi + internal->dim_cov;
  internal->offset_output_cov = 28 + internal->dim_whi + internal->dim_zhi;
  internal->offset_output_derivS = 28 + internal->dim_whi + internal->dim_zhi + internal->dim_cov + internal->dim_av_mosq;
  internal->offset_output_zhi = 28 + internal->dim_whi;
...
SEXP odin_model_emanators_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 414));
  ...
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_delay_incv));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_den));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_derivS));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_derivS_1));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_derivS_12));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_derivS_2));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_derivS_3));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_EIR));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_EIR_1));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_EIR_12));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_EIR_2));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_EIR_3));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_fd));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_FOI));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_FOI_1));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_FOI_12));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_FOI_2));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_FOI_3));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_foi_age));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_FOI_lag));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_FOI_lag_1));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_FOI_lag_12));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_FOI_lag_2));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_FOI_lag_3));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_FOIvijk));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_FOIvijk_1));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_FOIvijk_12));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_FOIvijk_2));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_FOIvijk_3));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_het_wt));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_IB));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_IB_1));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_IB_12));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_IB_2));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_IB_3));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_IC));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_IC_1));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_IC_12));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_IC_2));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_IC_3));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_ICA));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_ICA_1));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_ICA_12));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_ICA_2));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_ICA_3));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_ICM));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_ICM_1));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_ICM_12));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_ICM_2));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_ICM_3));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_ID));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_ID_1));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_ID_12));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_ID_2));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_ID_3));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_init_A));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_init_A_1));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_init_A_12));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_init_A_2));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_init_A_3));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_init_D));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_init_D_1));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_init_D_12));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_init_D_2));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_init_D_3));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_init_IB));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_init_IB_1));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_init_IB_12));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_init_IB_2));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_init_IB_3));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_init_ICA));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_init_ICA_1));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_init_ICA_12));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_init_ICA_2));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_init_ICA_3));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_init_ICM));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_init_ICM_1));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_init_ICM_12));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_init_ICM_2));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_init_ICM_3));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_init_ICM_pre));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_init_ICM_pre_1));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_init_ICM_pre_2));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_init_ID));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_init_ID_1));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_init_ID_12));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_init_ID_2));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_init_ID_3));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_init_P));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_init_P_1));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_init_P_12));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_init_P_2));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_init_P_3));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_init_S));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_init_S_1));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_init_S_12));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_init_S_2));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_init_S_3));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_init_T));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_init_T_1));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_init_T_12));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_init_T_2));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_init_T_3));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_init_U));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_init_U_1));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_init_U_12));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_init_U_2));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_init_U_3));
  ...
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_prevall));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_prevall_1));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_prevall_12));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_prevall_2));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_prevall_3));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_rel_foi));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_S_12));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_S_3));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_T_12));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_T_3));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_U_12));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_U_3));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_w_));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_whi));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_x_I));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_Y));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_Y_1));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_Y_12));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_Y_2));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_Y_3));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_yy));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_yy_));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_z));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_z_));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_zhi));
  SET_VECTOR_ELT(contents, 264, ScalarReal(internal->dLL));
  SET_VECTOR_ELT(contents, 265, ScalarReal(internal->dPL));
  ...
  SET_VECTOR_ELT(contents, 266, EIR);
  SET_VECTOR_ELT(contents, 267, ScalarReal(internal->em_cov));
  SET_VECTOR_ELT(contents, 268, ScalarReal(internal->EM_interval));
  SET_VECTOR_ELT(contents, 269, ScalarReal(internal->em_loss));
  SET_VECTOR_ELT(contents, 270, ScalarReal(internal->EM_on));
  SET_VECTOR_ELT(contents, 271, ScalarReal(internal->eta));
  SEXP fd = PROTECT(allocVector(REALSXP, internal->dim_fd));
  memcpy(REAL(fd), internal->fd, internal->dim_fd * sizeof(double));
  SET_VECTOR_ELT(contents, 272, fd);
  SET_VECTOR_ELT(contents, 273, ScalarReal(internal->fD0));
  ...
  SET_VECTOR_ELT(contents, 274, FOI);
  ...
  SET_VECTOR_ELT(contents, 275, foi_age);
  ...
  SET_VECTOR_ELT(contents, 276, FOI_lag);
  ...
  SET_VECTOR_ELT(contents, 277, FOIvijk);
  SET_VECTOR_ELT(contents, 278, ScalarReal(internal->ft));
  SET_VECTOR_ELT(contents, 279, ScalarReal(internal->gamma1));
  SET_VECTOR_ELT(contents, 280, ScalarReal(internal->gammaD));
  SET_VECTOR_ELT(contents, 281, ScalarReal(internal->gammaL));
  ...
  SET_VECTOR_ELT(contents, 282, het_wt);
  SET_VECTOR_ELT(contents, 283, ScalarReal(internal->hut_max));
  SET_VECTOR_ELT(contents, 284, ScalarReal(internal->hut_max_a));
  SET_VECTOR_ELT(contents, 285, ScalarReal(internal->IB0));
  ...
  SET_VECTOR_ELT(contents, 286, IC);
  SET_VECTOR_ELT(contents, 287, ScalarReal(internal->IC0));
  SET_VECTOR_ELT(contents, 288, ScalarReal(internal->ID0));
  ...
  SET_VECTOR_ELT(contents, 289, init_A);
  ...
  SET_VECTOR_ELT(contents, 290, init_D);
  SET_VECTOR_ELT(contents, 291, ScalarReal(internal->init_EL));
  SET_VECTOR_ELT(contents, 292, ScalarReal(internal->init_Ev));
  ...
  SET_VECTOR_ELT(contents, 293, init_IB);
  ...
  SET_VECTOR_ELT(contents, 294, init_ICA);
  ...
  SET_VECTOR_ELT(contents, 295, init_ICM);
  ...
  SET_VECTOR_ELT(contents, 296, init_ICM_pre);
  ...
  SET_VECTOR_ELT(contents, 297, init_ID);
  SET_VECTOR_ELT(contents, 298, ScalarReal(internal->init_Iv));
  SET_VECTOR_ELT(contents, 299, ScalarReal(internal->init_LL));
  ...
  SET_VECTOR_ELT(contents, 300, init_P);
  SET_VECTOR_ELT(contents, 301, ScalarReal(internal->init_PL));
  ...
  SET_VECTOR_ELT(contents, 302, init_S);
  SET_VECTOR_ELT(contents, 303, ScalarReal(internal->init_Sv));
  ...
  SET_VECTOR_ELT(contents, 304, init_T);
  ...
  SET_VECTOR_ELT(contents, 305, init_U);
  ...
  SET_VECTOR_ELT(contents, 306, initial_A);
  ...
  SET_VECTOR_ELT(contents, 307, initial_D);
  SET_VECTOR_ELT(contents, 308, ScalarReal(internal->initial_EL));
  SET_VECTOR_ELT(contents, 309, ScalarReal(internal->initial_Ev));
  ...
  SET_VECTOR_ELT(contents, 310, initial_IB);
  ...
  SET_VECTOR_ELT(contents, 311, initial_ICA);
  ...
  SET_VECTOR_ELT(contents, 312, initial_ICM);
  ...
  SET_VECTOR_ELT(contents, 313, initial_ID);
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->initial_Iv));
  SET_VECTOR_ELT(contents, 315, ScalarReal(internal->initial_LL));
  ...
  SET_VECTOR_ELT(contents, 316, initial_P);
  SET_VECTOR_ELT(contents, 317, ScalarReal(internal->initial_PL));
  ...
  SET_VECTOR_ELT(contents, 318, initial_S);
  SET_VECTOR_ELT(contents, 319, ScalarReal(internal->initial_Sv));
  SET_VECTOR_ELT(contents, 320, ScalarReal(internal->initial_t));
  ...
  SET_VECTOR_ELT(contents, 321, initial_T);
  ...
  SET_VECTOR_ELT(contents, 322, initial_U);
  SET_VECTOR_ELT(contents, 323, ScalarReal(internal->itn_cov));
  SET_VECTOR_ELT(contents, 324, ScalarReal(internal->itn_half_life));
  SET_VECTOR_ELT(contents, 325, ScalarReal(internal->ITN_interval));
  SET_VECTOR_ELT(contents, 326, ScalarReal(internal->itn_loss));
  SET_VECTOR_ELT(contents, 327, ScalarReal(internal->ITN_on));
  SET_VECTOR_ELT(contents, 328, ScalarReal(internal->jp1));
  ...
  SET_VECTOR_ELT(contents, 332, ScalarReal(internal->kp1));
  SET_VECTOR_ELT(contents, 333, ScalarReal(internal->lp1));
  SET_VECTOR_ELT(contents, 334, ScalarReal(internal->mort_assay));
  SET_VECTOR_ELT(contents, 335, ScalarReal(internal->mort_hut));
  SET_VECTOR_ELT(contents, 336, ScalarReal(internal->mort_hut_a));
  SET_VECTOR_ELT(contents, 337, ScalarReal(internal->mu0));
  SET_VECTOR_ELT(contents, 338, ScalarReal(internal->muEL));
  SET_VECTOR_ELT(contents, 339, ScalarReal(internal->muLL));
  SET_VECTOR_ELT(contents, 340, ScalarReal(internal->muPL));
  SET_VECTOR_ELT(contents, 341, ScalarReal(internal->mv0));
  SET_VECTOR_ELT(contents, 342, ScalarReal(internal->my_max_washes));
  SET_VECTOR_ELT(contents, 343, ScalarReal(internal->my_max_washes_a));
  SET_VECTOR_ELT(contents, 344, ScalarReal(internal->n1n0));
  SET_VECTOR_ELT(contents, 345, ScalarInteger(internal->na));
  SET_VECTOR_ELT(contents, 346, ScalarInteger(internal->nh));
  SET_VECTOR_ELT(contents, 347, ScalarInteger(internal->num_int));
  SET_VECTOR_ELT(contents, 348, ScalarInteger(internal->offset_FOIv_A));
  SET_VECTOR_ELT(contents, 349, ScalarInteger(internal->offset_FOIv_ID));
  SET_VECTOR_ELT(contents, 350, ScalarInteger(internal->offset_FOIv_U));
  SET_VECTOR_ELT(contents, 351, ScalarInteger(internal->offset_output_av_mosq));
  SET_VECTOR_ELT(contents, 352, ScalarInteger(internal->offset_output_cov));
  SET_VECTOR_ELT(contents, 353, ScalarInteger(internal->offset_output_derivS));
  SET_VECTOR_ELT(contents, 354, ScalarInteger(internal->offset_output_zhi));
  SET_VECTOR_ELT(contents, 355, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 356, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 357, ScalarInteger(internal->offset_variable_IB));
  SET_VECTOR_ELT(contents, 358, ScalarInteger(internal->offset_variable_ICA));
  SET_VECTOR_ELT(contents, 359, ScalarInteger(internal->offset_variable_ICM));
  SET_VECTOR_ELT(contents, 360, ScalarInteger(internal->offset_variable_ID));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->offset_variable_P));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->offset_variable_T));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->offset_variable_U));
  SET_VECTOR_ELT(contents, 364, ScalarReal(internal->omega));
  ...
  SET_VECTOR_ELT(contents, 365, p_det);
  SET_VECTOR_ELT(contents, 366, ScalarReal(internal->p10));
  SET_VECTOR_ELT(contents, 367, ScalarReal(internal->p2));
  ...
  SET_VECTOR_ELT(contents, 368, phi);
  SET_VECTOR_ELT(contents, 369, ScalarReal(internal->phi0));
  SET_VECTOR_ELT(contents, 370, ScalarReal(internal->phi1));
  SET_VECTOR_ELT(contents, 371, ScalarReal(internal->pi));
  SET_VECTOR_ELT(contents, 372, ScalarReal(internal->PM));
  ...
  SET_VECTOR_ELT(contents, 373, prev0to59);
  ...
  SET_VECTOR_ELT(contents, 374, prevall);
  SET_VECTOR_ELT(contents, 375, ScalarReal(internal->Q0));
  SET_VECTOR_ELT(contents, 376, ScalarReal(internal->r_EM0));
  SET_VECTOR_ELT(contents, 377, ScalarReal(internal->r_ITN_min));
  SET_VECTOR_ELT(contents, 378, ScalarReal(internal->r_ITN0));
  SET_VECTOR_ELT(contents, 379, ScalarReal(internal->rA));
  SET_VECTOR_ELT(contents, 380, ScalarReal(internal->rD));
  ...
  SET_VECTOR_ELT(contents, 381, rel_foi);
  SET_VECTOR_ELT(contents, 382, ScalarReal(internal->rep_hut));
  SET_VECTOR_ELT(contents, 383, ScalarReal(internal->rP));
  SET_VECTOR_ELT(contents, 384, ScalarReal(internal->rT));
  SET_VECTOR_ELT(contents, 385, ScalarReal(internal->rU));
  SET_VECTOR_ELT(contents, 386, ScalarReal(internal->ssa0));
  SET_VECTOR_ELT(contents, 387, ScalarReal(internal->ssa1));
  SET_VECTOR_ELT(contents, 388, ScalarReal(internal->ssa2));
  SET_VECTOR_ELT(contents, 389, ScalarReal(internal->ssa3));
  SET_VECTOR_ELT(contents, 390, ScalarReal(internal->ssb1));
  SET_VECTOR_ELT(contents, 391, ScalarReal(internal->ssb2));
  SET_VECTOR_ELT(contents, 392, ScalarReal(internal->ssb3));
  SET_VECTOR_ELT(contents, 393, ScalarReal(internal->suc_hut));
  SET_VECTOR_ELT(contents, 394, ScalarReal(internal->surv_bioassay));
  SET_VECTOR_ELT(contents, 395, ScalarReal(internal->tau1));
  SET_VECTOR_ELT(contents, 396, ScalarReal(internal->tau2));
  SET_VECTOR_ELT(contents, 397, ScalarReal(internal->theta_c));
  SET_VECTOR_ELT(contents, 398, ScalarReal(internal->uB));
  SET_VECTOR_ELT(contents, 399, ScalarReal(internal->uCA));
  SET_VECTOR_ELT(contents, 400, ScalarReal(internal->uD));
  ...
  SET_STRING_ELT(nms, 101, mkChar("dim_delay_incv"));
  SET_STRING_ELT(nms, 102, mkChar("dim_den"));
  SET_STRING_ELT(nms, 103, mkChar("dim_derivS"));
  SET_STRING_ELT(nms, 104, mkChar("dim_derivS_1"));
  SET_STRING_ELT(nms, 105, mkChar("dim_derivS_12"));
  SET_STRING_ELT(nms, 106, mkChar("dim_derivS_2"));
  SET_STRING_ELT(nms, 107, mkChar("dim_derivS_3"));
  SET_STRING_ELT(nms, 108, mkChar("dim_EIR"));
  SET_STRING_ELT(nms, 109, mkChar("dim_EIR_1"));
  SET_STRING_ELT(nms, 110, mkChar("dim_EIR_12"));
  SET_STRING_ELT(nms, 111, mkChar("dim_EIR_2"));
  SET_STRING_ELT(nms, 112, mkChar("dim_EIR_3"));
  SET_STRING_ELT(nms, 113, mkChar("dim_fd"));
  SET_STRING_ELT(nms, 114, mkChar("dim_FOI"));
  SET_STRING_ELT(nms, 115, mkChar("dim_FOI_1"));
  SET_STRING_ELT(nms, 116, mkChar("dim_FOI_12"));
  SET_STRING_ELT(nms, 117, mkChar("dim_FOI_2"));
  SET_STRING_ELT(nms, 118, mkChar("dim_FOI_3"));
  SET_STRING_ELT(nms, 119, mkChar("dim_foi_age"));
  SET_STRING_ELT(nms, 120, mkChar("dim_FOI_lag"));
  SET_STRING_ELT(nms, 121, mkChar("dim_FOI_lag_1"));
  SET_STRING_ELT(nms, 122, mkChar("dim_FOI_lag_12"));
  SET_STRING_ELT(nms, 123, mkChar("dim_FOI_lag_2"));
  SET_STRING_ELT(nms, 124, mkChar("dim_FOI_lag_3"));
  SET_STRING_ELT(nms, 125, mkChar("dim_FOIvijk"));
  SET_STRING_ELT(nms, 126, mkChar("dim_FOIvijk_1"));
  SET_STRING_ELT(nms, 127, mkChar("dim_FOIvijk_12"));
  SET_STRING_ELT(nms, 128, mkChar("dim_FOIvijk_2"));
  SET_STRING_ELT(nms, 129, mkChar("dim_FOIvijk_3"));
  SET_STRING_ELT(nms, 130, mkChar("dim_het_wt"));
  SET_STRING_ELT(nms, 131, mkChar("dim_IB"));
  SET_STRING_ELT(nms, 132, mkChar("dim_IB_1"));
  SET_STRING_ELT(nms, 133, mkChar("dim_IB_12"));
  SET_STRING_ELT(nms, 134, mkChar("dim_IB_2"));
  SET_STRING_ELT(nms, 135, mkChar("dim_IB_3"));
  SET_STRING_ELT(nms, 136, mkChar("dim_IC"));
  SET_STRING_ELT(nms, 137, mkChar("dim_IC_1"));
  SET_STRING_ELT(nms, 138, mkChar("dim_IC_12"));
  SET_STRING_ELT(nms, 139, mkChar("dim_IC_2"));
  SET_STRING_ELT(nms, 140, mkChar("dim_IC_3"));
  SET_STRING_ELT(nms, 141, mkChar("dim_ICA"));
  SET_STRING_ELT(nms, 142, mkChar("dim_ICA_1"));
  SET_STRING_ELT(nms, 143, mkChar("dim_ICA_12"));
  SET_STRING_ELT(nms, 144, mkChar("dim_ICA_2"));
  SET_STRING_ELT(nms, 145, mkChar("dim_ICA_3"));
  SET_STRING_ELT(nms, 146, mkChar("dim_ICM"));
  SET_STRING_ELT(nms, 147, mkChar("dim_ICM_1"));
  SET_STRING_ELT(nms, 148, mkChar("dim_ICM_12"));
  SET_STRING_ELT(nms, 149, mkChar("dim_ICM_2"));
  SET_STRING_ELT(nms, 150, mkChar("dim_ICM_3"));
  SET_STRING_ELT(nms, 151, mkChar("dim_ID"));
  SET_STRING_ELT(nms, 152, mkChar("dim_ID_1"));
  SET_STRING_ELT(nms, 153, mkChar("dim_ID_12"));
  SET_STRING_ELT(nms, 154, mkChar("dim_ID_2"));
  SET_STRING_ELT(nms, 155, mkChar("dim_ID_3"));
  SET_STRING_ELT(nms, 156, mkChar("dim_init_A"));
  SET_STRING_ELT(nms, 157, mkChar("dim_init_A_1"));
  SET_STRING_ELT(nms, 158, mkChar("dim_init_A_12"));
  SET_STRING_ELT(nms, 159, mkChar("dim_init_A_2"));
  SET_STRING_ELT(nms, 160, mkChar("dim_init_A_3"));
  SET_STRING_ELT(nms, 161, mkChar("dim_init_D"));
  SET_STRING_ELT(nms, 162, mkChar("dim_init_D_1"));
  SET_STRING_ELT(nms, 163, mkChar("dim_init_D_12"));
  SET_STRING_ELT(nms, 164, mkChar("dim_init_D_2"));
  SET_STRING_ELT(nms, 165, mkChar("dim_init_D_3"));
  SET_STRING_ELT(nms, 166, mkChar("dim_init_IB"));
  SET_STRING_ELT(nms, 167, mkChar("dim_init_IB_1"));
  SET_STRING_ELT(nms, 168, mkChar("dim_init_IB_12"));
  SET_STRING_ELT(nms, 169, mkChar("dim_init_IB_2"));
  SET_STRING_ELT(nms, 170, mkChar("dim_init_IB_3"));
  SET_STRING_ELT(nms, 171, mkChar("dim_init_ICA"));
  SET_STRING_ELT(nms, 172, mkChar("dim_init_ICA_1"));
  SET_STRING_ELT(nms, 173, mkChar("dim_init_ICA_12"));
  SET_STRING_ELT(nms, 174, mkChar("dim_init_ICA_2"));
  SET_STRING_ELT(nms, 175, mkChar("dim_init_ICA_3"));
  SET_STRING_ELT(nms, 176, mkChar("dim_init_ICM"));
  SET_STRING_ELT(nms, 177, mkChar("dim_init_ICM_1"));
  SET_STRING_ELT(nms, 178, mkChar("dim_init_ICM_12"));
  SET_STRING_ELT(nms, 179, mkChar("dim_init_ICM_2"));
  SET_STRING_ELT(nms, 180, mkChar("dim_init_ICM_3"));
  SET_STRING_ELT(nms, 181, mkChar("dim_init_ICM_pre"));
  SET_STRING_ELT(nms, 182, mkChar("dim_init_ICM_pre_1"));
  SET_STRING_ELT(nms, 183, mkChar("dim_init_ICM_pre_2"));
  SET_STRING_ELT(nms, 184, mkChar("dim_init_ID"));
  SET_STRING_ELT(nms, 185, mkChar("dim_init_ID_1"));
  SET_STRING_ELT(nms, 186, mkChar("dim_init_ID_12"));
  SET_STRING_ELT(nms, 187, mkChar("dim_init_ID_2"));
  SET_STRING_ELT(nms, 188, mkChar("dim_init_ID_3"));
  SET_STRING_ELT(nms, 189, mkChar("dim_init_P"));
  SET_STRING_ELT(nms, 190, mkChar("dim_init_P_1"));
  SET_STRING_ELT(nms, 191, mkChar("dim_init_P_12"));
  SET_STRING_ELT(nms, 192, mkChar("dim_init_P_2"));
  SET_STRING_ELT(nms, 193, mkChar("dim_init_P_3"));
  SET_STRING_ELT(nms, 194, mkChar("dim_init_S"));
  SET_STRING_ELT(nms, 195, mkChar("dim_init_S_1"));
  SET_STRING_ELT(nms, 196, mkChar("dim_init_S_12"));
  SET_STRING_ELT(nms, 197, mkChar("dim_init_S_2"));
  SET_STRING_ELT(nms, 198, mkChar("dim_init_S_3"));
  SET_STRING_ELT(nms, 199, mkChar("dim_init_T"));
  SET_STRING_ELT(nms, 200, mkChar("dim_init_T_1"));
  SET_STRING_ELT(nms, 201, mkChar("dim_init_T_12"));
  SET_STRING_ELT(nms, 202, mkChar("dim_init_T_2"));
  SET_STRING_ELT(nms, 203, mkChar("dim_init_T_3"));
  SET_STRING_ELT(nms, 204, mkChar("dim_init_U"));
  SET_STRING_ELT(nms, 205, mkChar("dim_init_U_1"));
  SET_STRING_ELT(nms, 206, mkChar("dim_init_U_12"));
  SET_STRING_ELT(nms, 207, mkChar("dim_init_U_2"));
  SET_STRING_ELT(nms, 208, mkChar("dim_init_U_3"));
  ...
  SET_STRING_ELT(nms, 229, mkChar("dim_prevall"));
  SET_STRING_ELT(nms, 230, mkChar("dim_prevall_1"));
  SET_STRING_ELT(nms, 231, mkChar("dim_prevall_12"));
  SET_STRING_ELT(nms, 232, mkChar("dim_prevall_2"));
  SET_STRING_ELT(nms, 233, mkChar("dim_prevall_3"));
  SET_STRING_ELT(nms, 234, mkChar("dim_rel_foi"));
  SET_STRING_ELT(nms, 235, mkChar("dim_S"));
  SET_STRING_ELT(nms, 236, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 237, mkChar("dim_S_12"));
  SET_STRING_ELT(nms, 238, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 239, mkChar("dim_S_3"));
  SET_STRING_ELT(nms, 240, mkChar("dim_T"));
  SET_STRING_ELT(nms, 241, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 242, mkChar("dim_T_12"));
  SET_STRING_ELT(nms, 243, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 244, mkChar("dim_T_3"));
  SET_STRING_ELT(nms, 245, mkChar("dim_U"));
  SET_STRING_ELT(nms, 246, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 247, mkChar("dim_U_12"));
  SET_STRING_ELT(nms, 248, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 249, mkChar("dim_U_3"));
  SET_STRING_ELT(nms, 250, mkChar("dim_w"));
  SET_STRING_ELT(nms, 251, mkChar("dim_w_"));
  SET_STRING_ELT(nms, 252, mkChar("dim_whi"));
  SET_STRING_ELT(nms, 253, mkChar("dim_x_I"));
  SET_STRING_ELT(nms, 254, mkChar("dim_Y"));
  SET_STRING_ELT(nms, 255, mkChar("dim_Y_1"));
  SET_STRING_ELT(nms, 256, mkChar("dim_Y_12"));
  SET_STRING_ELT(nms, 257, mkChar("dim_Y_2"));
  SET_STRING_ELT(nms, 258, mkChar("dim_Y_3"));
  SET_STRING_ELT(nms, 259, mkChar("dim_yy"));
  SET_STRING_ELT(nms, 260, mkChar("dim_yy_"));
  SET_STRING_ELT(nms, 261, mkChar("dim_z"));
  SET_STRING_ELT(nms, 262, mkChar("dim_z_"));
  SET_STRING_ELT(nms, 263, mkChar("dim_zhi"));
  SET_STRING_ELT(nms, 264, mkChar("dLL"));
  SET_STRING_ELT(nms, 265, mkChar("dPL"));
  SET_STRING_ELT(nms, 266, mkChar("EIR"));
  SET_STRING_ELT(nms, 267, mkChar("em_cov"));
  SET_STRING_ELT(nms, 268, mkChar("EM_interval"));
  SET_STRING_ELT(nms, 269, mkChar("em_loss"));
  SET_STRING_ELT(nms, 270, mkChar("EM_on"));
  SET_STRING_ELT(nms, 271, mkChar("eta"));
  SET_STRING_ELT(nms, 272, mkChar("fd"));
  SET_STRING_ELT(nms, 273, mkChar("fD0"));
  SET_STRING_ELT(nms, 274, mkChar("FOI"));
  SET_STRING_ELT(nms, 275, mkChar("foi_age"));
  SET_STRING_ELT(nms, 276, mkChar("FOI_lag"));
  SET_STRING_ELT(nms, 277, mkChar("FOIvijk"));
  SET_STRING_ELT(nms, 278, mkChar("ft"));
  SET_STRING_ELT(nms, 279, mkChar("gamma1"));
  SET_STRING_ELT(nms, 280, mkChar("gammaD"));
  SET_STRING_ELT(nms, 281, mkChar("gammaL"));
  SET_STRING_ELT(nms, 282, mkChar("het_wt"));
  SET_STRING_ELT(nms, 283, mkChar("hut_max"));
  SET_STRING_ELT(nms, 284, mkChar("hut_max_a"));
  SET_STRING_ELT(nms, 285, mkChar("IB0"));
  SET_STRING_ELT(nms, 286, mkChar("IC"));
  SET_STRING_ELT(nms, 287, mkChar("IC0"));
  SET_STRING_ELT(nms, 288, mkChar("ID0"));
  SET_STRING_ELT(nms, 289, mkChar("init_A"));
  SET_STRING_ELT(nms, 290, mkChar("init_D"));
  SET_STRING_ELT(nms, 291, mkChar("init_EL"));
  SET_STRING_ELT(nms, 292, mkChar("init_Ev"));
  SET_STRING_ELT(nms, 293, mkChar("init_IB"));
  SET_STRING_ELT(nms, 294, mkChar("init_ICA"));
  SET_STRING_ELT(nms, 295, mkChar("init_ICM"));
  SET_STRING_ELT(nms, 296, mkChar("init_ICM_pre"));
  SET_STRING_ELT(nms, 297, mkChar("init_ID"));
  SET_STRING_ELT(nms, 298, mkChar("init_Iv"));
  SET_STRING_ELT(nms, 299, mkChar("init_LL"));
  SET_STRING_ELT(nms, 300, mkChar("init_P"));
  SET_STRING_ELT(nms, 301, mkChar("init_PL"));
  SET_STRING_ELT(nms, 302, mkChar("init_S"));
  SET_STRING_ELT(nms, 303, mkChar("init_Sv"));
  SET_STRING_ELT(nms, 304, mkChar("init_T"));
  SET_STRING_ELT(nms, 305, mkChar("init_U"));
  SET_STRING_ELT(nms, 306, mkChar("initial_A"));
  SET_STRING_ELT(nms, 307, mkChar("initial_D"));
  SET_STRING_ELT(nms, 308, mkChar("initial_EL"));
  SET_STRING_ELT(nms, 309, mkChar("initial_Ev"));
  SET_STRING_ELT(nms, 310, mkChar("initial_IB"));
  SET_STRING_ELT(nms, 311, mkChar("initial_ICA"));
  SET_STRING_ELT(nms, 312, mkChar("initial_ICM"));
  SET_STRING_ELT(nms, 313, mkChar("initial_ID"));
  SET_STRING_ELT(nms, 314, mkChar("initial_Iv"));
  SET_STRING_ELT(nms, 315, mkChar("initial_LL"));
  SET_STRING_ELT(nms, 316, mkChar("initial_P"));
  SET_STRING_ELT(nms, 317, mkChar("initial_PL"));
  SET_STRING_ELT(nms, 318, mkChar("initial_S"));
  SET_STRING_ELT(nms, 319, mkChar("initial_Sv"));
  SET_STRING_ELT(nms, 320, mkChar("initial_t"));
  SET_STRING_ELT(nms, 321, mkChar("initial_T"));
  SET_STRING_ELT(nms, 322, mkChar("initial_U"));
  SET_STRING_ELT(nms, 323, mkChar("itn_cov"));
  SET_STRING_ELT(nms, 324, mkChar("itn_half_life"));
  SET_STRING_ELT(nms, 325, mkChar("ITN_interval"));
  SET_STRING_ELT(nms, 326, mkChar("itn_loss"));
  SET_STRING_ELT(nms, 327, mkChar("ITN_on"));
  SET_STRING_ELT(nms, 328, mkChar("jp1"));
  SET_STRING_ELT(nms, 329, mkChar("kB"));
  SET_STRING_ELT(nms, 330, mkChar("kC"));
  SET_STRING_ELT(nms, 331, mkChar("kD"));
  SET_STRING_ELT(nms, 332, mkChar("kp1"));
  SET_STRING_ELT(nms, 333, mkChar("lp1"));
  SET_STRING_ELT(nms, 334, mkChar("mort_assay"));
  SET_STRING_ELT(nms, 335, mkChar("mort_hut"));
  SET_STRING_ELT(nms, 336, mkChar("mort_hut_a"));
  SET_STRING_ELT(nms, 337, mkChar("mu0"));
  SET_STRING_ELT(nms, 338, mkChar("muEL"));
  SET_STRING_ELT(nms, 339, mkChar("muLL"));
  SET_STRING_ELT(nms, 340, mkChar("muPL"));
  SET_STRING_ELT(nms, 341, mkChar("mv0"));
  SET_STRING_ELT(nms, 342, mkChar("my_max_washes"));
  SET_STRING_ELT(nms, 343, mkChar("my_max_washes_a"));
  SET_STRING_ELT(nms, 344, mkChar("n1n0"));
  SET_STRING_ELT(nms, 345, mkChar("na"));
  SET_STRING_ELT(nms, 346, mkChar("nh"));
  SET_STRING_ELT(nms, 347, mkChar("num_int"));
  SET_STRING_ELT(nms, 348, mkChar("offset_FOIv_A"));
  SET_STRING_ELT(nms, 349, mkChar("offset_FOIv_ID"));
  SET_STRING_ELT(nms, 350, mkChar("offset_FOIv_U"));
  SET_STRING_ELT(nms, 351, mkChar("offset_output_av_mosq"));
  SET_STRING_ELT(nms, 352, mkChar("offset_output_cov"));
  SET_STRING_ELT(nms, 353, mkChar("offset_output_derivS"));
  SET_STRING_ELT(nms, 354, mkChar("offset_output_zhi"));
  SET_STRING_ELT(nms, 355, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 356, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 357, mkChar("offset_variable_IB"));
  SET_STRING_ELT(nms, 358, mkChar("offset_variable_ICA"));
  SET_STRING_ELT(nms, 359, mkChar("offset_variable_ICM"));
  SET_STRING_ELT(nms, 360, mkChar("offset_variable_ID"));
  SET_STRING_ELT(nms, 361, mkChar("offset_variable_P"));
  SET_STRING_ELT(nms, 362, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 363, mkChar("offset_variable_U"));
  SET_STRING_ELT(nms, 364, mkChar("omega"));
  SET_STRING_ELT(nms, 365, mkChar("p_det"));
  SET_STRING_ELT(nms, 366, mkChar("p10"));
  SET_STRING_ELT(nms, 367, mkChar("p2"));
  SET_STRING_ELT(nms, 368, mkChar("phi"));
  SET_STRING_ELT(nms, 369, mkChar("phi0"));
  SET_STRING_ELT(nms, 370, mkChar("phi1"));
  SET_STRING_ELT(nms, 371, mkChar("pi"));
  SET_STRING_ELT(nms, 372, mkChar("PM"));
  SET_STRING_ELT(nms, 373, mkChar("prev0to59"));
  SET_STRING_ELT(nms, 374, mkChar("prevall"));
  SET_STRING_ELT(nms, 375, mkChar("Q0"));
  SET_STRING_ELT(nms, 376, mkChar("r_EM0"));
  SET_STRING_ELT(nms, 377, mkChar("r_ITN_min"));
  SET_STRING_ELT(nms, 378, mkChar("r_ITN0"));
  SET_STRING_ELT(nms, 379, mkChar("rA"));
  SET_STRING_ELT(nms, 380, mkChar("rD"));
  SET_STRING_ELT(nms, 381, mkChar("rel_foi"));
  SET_STRING_ELT(nms, 382, mkChar("rep_hut"));
  SET_STRING_ELT(nms, 383, mkChar("rP"));
  SET_STRING_ELT(nms, 384, mkChar("rT"));
  SET_STRING_ELT(nms, 385, mkChar("rU"));
  SET_STRING_ELT(nms, 386, mkChar("ssa0"));
  SET_STRING_ELT(nms, 387, mkChar("ssa1"));
  SET_STRING_ELT(nms, 388, mkChar("ssa2"));
  SET_STRING_ELT(nms, 389, mkChar("ssa3"));
  SET_STRING_ELT(nms, 390, mkChar("ssb1"));
  SET_STRING_ELT(nms, 391, mkChar("ssb2"));
  SET_STRING_ELT(nms, 392, mkChar("ssb3"));
  SET_STRING_ELT(nms, 393, mkChar("suc_hut"));
  SET_STRING_ELT(nms, 394, mkChar("surv_bioassay"));
  SET_STRING_ELT(nms, 395, mkChar("tau1"));
  SET_STRING_ELT(nms, 396, mkChar("tau2"));
  SET_STRING_ELT(nms, 397, mkChar("theta_c"));
  SET_STRING_ELT(nms, 398, mkChar("uB"));
  SET_STRING_ELT(nms, 399, mkChar("uCA"));
  SET_STRING_ELT(nms, 400, mkChar("uD"));
  SET_STRING_ELT(nms, 401, mkChar("w"));
  SET_STRING_ELT(nms, 402, mkChar("w_"));
  SET_STRING_ELT(nms, 403, mkChar("wash_decay_rate"));
  SET_STRING_ELT(nms, 404, mkChar("wash_decay_rate_a"));
  SET_STRING_ELT(nms, 405, mkChar("whi"));
  SET_STRING_ELT(nms, 406, mkChar("x_I"));
  SET_STRING_ELT(nms, 407, mkChar("Y"));
  SET_STRING_ELT(nms, 408, mkChar("yy"));
  SET_STRING_ELT(nms, 409, mkChar("yy_"));
  SET_STRING_ELT(nms, 410, mkChar("z"));
  SET_STRING_ELT(nms, 411, mkChar("z_"));
  SET_STRING_ELT(nms, 412, mkChar("zhi"));
  SET_STRING_ELT(nms, 413, mkChar("odin_model_emanators_use_dde"));
...
SEXP odin_model_emanators_metadata(SEXP internal_p) {
  ...
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(28 + internal->dim_whi + internal->dim_zhi + internal->dim_cov + internal->dim_av_mosq + internal->dim_derivS));
  UNPROTECT(2);
  return ret;
}
SEXP odin_model_emanators_initial_conditions(SEXP internal_p, SEXP t_ptr) {
...
void odin_model_emanators_rhs(odin_model_emanators_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  double incv;
  {
    ...
    if (t <= internal->initial_t) {
      ...
      lagvalue(t, internal->odin_model_emanators_use_dde, internal->delay_index_incv, internal->dim_delay_incv, internal->delay_state_incv);
...
SEXP odin_model_emanators_rhs_r(SEXP internal_p, SEXP t, SEXP state) {
  ...
  odin_model_emanators_internal *internal = odin_model_emanators_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, 28 + internal->dim_whi + internal->dim_zhi + internal->dim_cov + internal->dim_av_mosq + internal->dim_derivS));
...
SEXP odin_model_hrp2_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 381));
  SET_VECTOR_ELT(contents, 0, ScalarReal(internal->aD));
  SEXP age = PROTECT(allocVector(REALSXP, internal->dim_age));
  memcpy(REAL(age), internal->age, internal->dim_age * sizeof(double));
  SET_VECTOR_ELT(contents, 1, age);
  ...
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_Ev));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_fd));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_FOI));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_FOI_1));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_FOI_12));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_FOI_2));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_FOI_3));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_foi_age));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_FOI_lag));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_FOI_lag_1));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_FOI_lag_12));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_FOI_lag_2));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_FOI_lag_3));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_FOIvijk));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_FOIvijk_1));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_FOIvijk_12));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_FOIvijk_2));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_FOIvijk_3));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_het_wt));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_IB));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_IB_1));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_IB_12));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_IB_2));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_IB_3));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_IC));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_IC_1));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_IC_12));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_IC_2));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_IC_3));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_ICA));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_ICA_1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_ICA_12));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_ICA_2));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_ICA_3));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_ICM));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_ICM_1));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_ICM_12));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_ICM_2));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_ICM_3));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_ID));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_ID_1));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_ID_12));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_ID_2));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_ID_3));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_init_A));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_init_A_1));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_init_A_12));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_init_A_2));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_init_A_3));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_init_D));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_init_D_1));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_init_D_12));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_init_D_2));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_init_D_3));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_init_IB));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_init_IB_1));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_init_IB_12));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_init_IB_2));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_init_IB_3));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_init_ICA));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_init_ICA_1));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_init_ICA_12));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_init_ICA_2));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_init_ICA_3));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_init_ICM));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_init_ICM_1));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_init_ICM_12));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_init_ICM_2));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_init_ICM_3));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_init_ICM_pre));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_init_ICM_pre_1));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_init_ICM_pre_2));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_init_ID));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_init_ID_1));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_init_ID_12));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_init_ID_2));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_init_ID_3));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_init_P));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_init_P_1));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_init_P_12));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_init_P_2));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_init_P_3));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_init_S));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_init_S_1));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_init_S_12));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_init_S_2));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_init_S_3));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_init_T));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_init_T_1));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_init_T_12));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_init_T_2));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_init_T_3));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_init_U));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_init_U_1));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_init_U_12));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_init_U_2));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_init_U_3));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_P));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_P_1));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_P_12));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_P_2));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_P_3));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_p_det));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_p_det_1));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_p_det_12));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_p_det_2));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_p_det_3));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_phi));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_phi_1));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_phi_12));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_phi_2));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_phi_3));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_prev0to59));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_prev0to59_1));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_prev0to59_12));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_prev0to59_2));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_prev0to59_3));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_rel_foi));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_S_12));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_S_3));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_T_12));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_T_3));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_U_12));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_U_3));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_w_));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_whi));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_x_I));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_Y));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_Y_1));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_Y_12));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_Y_2));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_Y_3));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_yy));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_yy_));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_z));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_z_));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_zhi));
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->dLL));
  SET_VECTOR_ELT(contents, 253, ScalarReal(internal->dPL));
  SEXP EIR = PROTECT(allocVector(REALSXP, internal->dim_EIR));
  memcpy(REAL(EIR), internal->EIR, internal->dim_EIR * sizeof(double));
  odin_set_dim(EIR, 3, internal->dim_EIR_1, internal->dim_EIR_2, internal->dim_EIR_3);
  SET_VECTOR_ELT(contents, 254, EIR);
  SET_VECTOR_ELT(contents, 255, ScalarReal(internal->eta));
  SEXP fd = PROTECT(allocVector(REALSXP, internal->dim_fd));
  memcpy(REAL(fd), internal->fd, internal->dim_fd * sizeof(double));
  SET_VECTOR_ELT(contents, 256, fd);
  SET_VECTOR_ELT(contents, 257, ScalarReal(internal->fD0));
  SEXP FOI = PROTECT(allocVector(REALSXP, internal->dim_FOI));
  memcpy(REAL(FOI), internal->FOI, internal->dim_FOI * sizeof(double));
  odin_set_dim(FOI, 3, internal->dim_FOI_1, internal->dim_FOI_2, internal->dim_FOI_3);
  SET_VECTOR_ELT(contents, 258, FOI);
  SEXP foi_age = PROTECT(allocVector(REALSXP, internal->dim_foi_age));
  memcpy(REAL(foi_age), internal->foi_age, internal->dim_foi_age * sizeof(double));
  SET_VECTOR_ELT(contents, 259, foi_age);
  SEXP FOI_lag = PROTECT(allocVector(REALSXP, internal->dim_FOI_lag));
  memcpy(REAL(FOI_lag), internal->FOI_lag, internal->dim_FOI_lag * sizeof(double));
  odin_set_dim(FOI_lag, 3, internal->dim_FOI_lag_1, internal->dim_FOI_lag_2, internal->dim_FOI_lag_3);
  SET_VECTOR_ELT(contents, 260, FOI_lag);
  SEXP FOIvijk = PROTECT(allocVector(REALSXP, internal->dim_FOIvijk));
  memcpy(REAL(FOIvijk), internal->FOIvijk, internal->dim_FOIvijk * sizeof(double));
  odin_set_dim(FOIvijk, 3, internal->dim_FOIvijk_1, internal->dim_FOIvijk_2, internal->dim_FOIvijk_3);
  SET_VECTOR_ELT(contents, 261, FOIvijk);
  SET_VECTOR_ELT(contents, 262, ScalarReal(internal->ft));
  SET_VECTOR_ELT(contents, 263, ScalarReal(internal->gamma1));
  SET_VECTOR_ELT(contents, 264, ScalarReal(internal->gammaD));
  SET_VECTOR_ELT(contents, 265, ScalarReal(internal->gammaL));
  SEXP het_wt = PROTECT(allocVector(REALSXP, internal->dim_het_wt));
  memcpy(REAL(het_wt), internal->het_wt, internal->dim_het_wt * sizeof(double));
  SET_VECTOR_ELT(contents, 266, het_wt);
  SET_VECTOR_ELT(contents, 267, ScalarReal(internal->hrp2_prop));
  SET_VECTOR_ELT(contents, 268, ScalarReal(internal->IB0));
  SEXP IC = PROTECT(allocVector(REALSXP, internal->dim_IC));
  memcpy(REAL(IC), internal->IC, internal->dim_IC * sizeof(double));
  odin_set_dim(IC, 3, internal->dim_IC_1, internal->dim_IC_2, internal->dim_IC_3);
  SET_VECTOR_ELT(contents, 269, IC);
  SET_VECTOR_ELT(contents, 270, ScalarReal(internal->IC0));
  SET_VECTOR_ELT(contents, 271, ScalarReal(internal->ID0));
  SEXP init_A = PROTECT(allocVector(REALSXP, internal->dim_init_A));
  memcpy(REAL(init_A), internal->init_A, internal->dim_init_A * sizeof(double));
  odin_set_dim(init_A, 3, internal->dim_init_A_1, internal->dim_init_A_2, internal->dim_init_A_3);
  SET_VECTOR_ELT(contents, 272, init_A);
  SEXP init_D = PROTECT(allocVector(REALSXP, internal->dim_init_D));
  memcpy(REAL(init_D), internal->init_D, internal->dim_init_D * sizeof(double));
  odin_set_dim(init_D, 3, internal->dim_init_D_1, internal->dim_init_D_2, internal->dim_init_D_3);
  SET_VECTOR_ELT(contents, 273, init_D);
  SET_VECTOR_ELT(contents, 274, ScalarReal(internal->init_EL));
  SET_VECTOR_ELT(contents, 275, ScalarReal(internal->init_Ev));
  SEXP init_IB = PROTECT(allocVector(REALSXP, internal->dim_init_IB));
  memcpy(REAL(init_IB), internal->init_IB, internal->dim_init_IB * sizeof(double));
  odin_set_dim(init_IB, 3, internal->dim_init_IB_1, internal->dim_init_IB_2, internal->dim_init_IB_3);
  SET_VECTOR_ELT(contents, 276, init_IB);
  SEXP init_ICA = PROTECT(allocVector(REALSXP, internal->dim_init_ICA));
  memcpy(REAL(init_ICA), internal->init_ICA, internal->dim_init_ICA * sizeof(double));
  odin_set_dim(init_ICA, 3, internal->dim_init_ICA_1, internal->dim_init_ICA_2, internal->dim_init_ICA_3);
  SET_VECTOR_ELT(contents, 277, init_ICA);
  SEXP init_ICM = PROTECT(allocVector(REALSXP, internal->dim_init_ICM));
  memcpy(REAL(init_ICM), internal->init_ICM, internal->dim_init_ICM * sizeof(double));
  odin_set_dim(init_ICM, 3, internal->dim_init_ICM_1, internal->dim_init_ICM_2, internal->dim_init_ICM_3);
  SET_VECTOR_ELT(contents, 278, init_ICM);
  SEXP init_ICM_pre = PROTECT(allocVector(REALSXP, internal->dim_init_ICM_pre));
  memcpy(REAL(init_ICM_pre), internal->init_ICM_pre, internal->dim_init_ICM_pre * sizeof(double));
  odin_set_dim(init_ICM_pre, 2, internal->dim_init_ICM_pre_1, internal->dim_init_ICM_pre_2);
  SET_VECTOR_ELT(contents, 279, init_ICM_pre);
  SEXP init_ID = PROTECT(allocVector(REALSXP, internal->dim_init_ID));
  memcpy(REAL(init_ID), internal->init_ID, internal->dim_init_ID * sizeof(double));
  odin_set_dim(init_ID, 3, internal->dim_init_ID_1, internal->dim_init_ID_2, internal->dim_init_ID_3);
  SET_VECTOR_ELT(contents, 280, init_ID);
  SET_VECTOR_ELT(contents, 281, ScalarReal(internal->init_Iv));
  SET_VECTOR_ELT(contents, 282, ScalarReal(internal->init_LL));
  SEXP init_P = PROTECT(allocVector(REALSXP, internal->dim_init_P));
  memcpy(REAL(init_P), internal->init_P, internal->dim_init_P * sizeof(double));
  odin_set_dim(init_P, 3, internal->dim_init_P_1, internal->dim_init_P_2, internal->dim_init_P_3);
  SET_VECTOR_ELT(contents, 283, init_P);
  SET_VECTOR_ELT(contents, 284, ScalarReal(internal->init_PL));
  SEXP init_S = PROTECT(allocVector(REALSXP, internal->dim_init_S));
  memcpy(REAL(init_S), internal->init_S, internal->dim_init_S * sizeof(double));
  odin_set_dim(init_S, 3, internal->dim_init_S_1, internal->dim_init_S_2, internal->dim_init_S_3);
  SET_VECTOR_ELT(contents, 285, init_S);
  SET_VECTOR_ELT(contents, 286, ScalarReal(internal->init_Sv));
  SEXP init_T = PROTECT(allocVector(REALSXP, internal->dim_init_T));
  memcpy(REAL(init_T), internal->init_T, internal->dim_init_T * sizeof(double));
  odin_set_dim(init_T, 3, internal->dim_init_T_1, internal->dim_init_T_2, internal->dim_init_T_3);
  SET_VECTOR_ELT(contents, 287, init_T);
  SEXP init_U = PROTECT(allocVector(REALSXP, internal->dim_init_U));
  memcpy(REAL(init_U), internal->init_U, internal->dim_init_U * sizeof(double));
  odin_set_dim(init_U, 3, internal->dim_init_U_1, internal->dim_init_U_2, internal->dim_init_U_3);
  SET_VECTOR_ELT(contents, 288, init_U);
  SEXP initial_A = PROTECT(allocVector(REALSXP, internal->dim_A));
  memcpy(REAL(initial_A), internal->initial_A, internal->dim_A * sizeof(double));
  odin_set_dim(initial_A, 3, internal->dim_A_1, internal->dim_A_2, internal->dim_A_3);
  SET_VECTOR_ELT(contents, 289, initial_A);
  SEXP initial_D = PROTECT(allocVector(REALSXP, internal->dim_D));
  memcpy(REAL(initial_D), internal->initial_D, internal->dim_D * sizeof(double));
  odin_set_dim(initial_D, 3, internal->dim_D_1, internal->dim_D_2, internal->dim_D_3);
  SET_VECTOR_ELT(contents, 290, initial_D);
  SET_VECTOR_ELT(contents, 291, ScalarReal(internal->initial_EL));
  ...
  SET_VECTOR_ELT(contents, 292, initial_Ev);
  SEXP initial_IB = PROTECT(allocVector(REALSXP, internal->dim_IB));
  memcpy(REAL(initial_IB), internal->initial_IB, internal->dim_IB * sizeof(double));
  odin_set_dim(initial_IB, 3, internal->dim_IB_1, internal->dim_IB_2, internal->dim_IB_3);
  SET_VECTOR_ELT(contents, 293, initial_IB);
  SEXP initial_ICA = PROTECT(allocVector(REALSXP, internal->dim_ICA));
  memcpy(REAL(initial_ICA), internal->initial_ICA, internal->dim_ICA * sizeof(double));
  odin_set_dim(initial_ICA, 3, internal->dim_ICA_1, internal->dim_ICA_2, internal->dim_ICA_3);
  SET_VECTOR_ELT(contents, 294, initial_ICA);
  SEXP initial_ICM = PROTECT(allocVector(REALSXP, internal->dim_ICM));
  memcpy(REAL(initial_ICM), internal->initial_ICM, internal->dim_ICM * sizeof(double));
  odin_set_dim(initial_ICM, 3, internal->dim_ICM_1, internal->dim_ICM_2, internal->dim_ICM_3);
  SET_VECTOR_ELT(contents, 295, initial_ICM);
  SEXP initial_ID = PROTECT(allocVector(REALSXP, internal->dim_ID));
  memcpy(REAL(initial_ID), internal->initial_ID, internal->dim_ID * sizeof(double));
  odin_set_dim(initial_ID, 3, internal->dim_ID_1, internal->dim_ID_2, internal->dim_ID_3);
  SET_VECTOR_ELT(contents, 296, initial_ID);
  SET_VECTOR_ELT(contents, 297, ScalarReal(internal->initial_Iv));
  SET_VECTOR_ELT(contents, 298, ScalarReal(internal->initial_LL));
  SEXP initial_P = PROTECT(allocVector(REALSXP, internal->dim_P));
  memcpy(REAL(initial_P), internal->initial_P, internal->dim_P * sizeof(double));
  odin_set_dim(initial_P, 3, internal->dim_P_1, internal->dim_P_2, internal->dim_P_3);
  SET_VECTOR_ELT(contents, 299, initial_P);
  SET_VECTOR_ELT(contents, 300, ScalarReal(internal->initial_PL));
  SEXP initial_S = PROTECT(allocVector(REALSXP, internal->dim_S));
  memcpy(REAL(initial_S), internal->initial_S, internal->dim_S * sizeof(double));
  odin_set_dim(initial_S, 3, internal->dim_S_1, internal->dim_S_2, internal->dim_S_3);
  SET_VECTOR_ELT(contents, 301, initial_S);
  SET_VECTOR_ELT(contents, 302, ScalarReal(internal->initial_Sv));
  SET_VECTOR_ELT(contents, 303, ScalarReal(internal->initial_t));
  SEXP initial_T = PROTECT(allocVector(REALSXP, internal->dim_T));
  memcpy(REAL(initial_T), internal->initial_T, internal->dim_T * sizeof(double));
  odin_set_dim(initial_T, 3, internal->dim_T_1, internal->dim_T_2, internal->dim_T_3);
  SET_VECTOR_ELT(contents, 304, initial_T);
  SEXP initial_U = PROTECT(allocVector(REALSXP, internal->dim_U));
  memcpy(REAL(initial_U), internal->initial_U, internal->dim_U * sizeof(double));
  odin_set_dim(initial_U, 3, internal->dim_U_1, internal->dim_U_2, internal->dim_U_3);
  SET_VECTOR_ELT(contents, 305, initial_U);
  SET_VECTOR_ELT(contents, 306, ScalarReal(internal->irs_cov));
  SET_VECTOR_ELT(contents, 307, ScalarReal(internal->IRS_interval));
  SET_VECTOR_ELT(contents, 308, ScalarReal(internal->irs_loss));
  SET_VECTOR_ELT(contents, 309, ScalarReal(internal->itn_cov));
  SET_VECTOR_ELT(contents, 310, ScalarReal(internal->ITN_interval));
  SET_VECTOR_ELT(contents, 311, ScalarReal(internal->ITN_IRS_on));
  SET_VECTOR_ELT(contents, 312, ScalarReal(internal->itn_loss));
  SET_VECTOR_ELT(contents, 313, ScalarReal(internal->kB));
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->kC));
  SET_VECTOR_ELT(contents, 315, ScalarReal(internal->kD));
  SET_VECTOR_ELT(contents, 316, ScalarReal(internal->mu0));
  SET_VECTOR_ELT(contents, 317, ScalarReal(internal->muEL));
  SET_VECTOR_ELT(contents, 318, ScalarReal(internal->muLL));
  SET_VECTOR_ELT(contents, 319, ScalarReal(internal->muPL));
  SET_VECTOR_ELT(contents, 320, ScalarReal(internal->mv0));
  SET_VECTOR_ELT(contents, 321, ScalarInteger(internal->na));
  SET_VECTOR_ELT(contents, 322, ScalarInteger(internal->nh));
  SET_VECTOR_ELT(contents, 323, ScalarInteger(internal->num_int));
  SET_VECTOR_ELT(contents, 324, ScalarInteger(internal->offset_FOIv_A));
  SET_VECTOR_ELT(contents, 325, ScalarInteger(internal->offset_FOIv_ID));
  SET_VECTOR_ELT(contents, 326, ScalarInteger(internal->offset_FOIv_U));
  SET_VECTOR_ELT(contents, 327, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 328, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 329, ScalarInteger(internal->offset_variable_IB));
  SET_VECTOR_ELT(contents, 330, ScalarInteger(internal->offset_variable_ICA));
  SET_VECTOR_ELT(contents, 331, ScalarInteger(internal->offset_variable_ICM));
  SET_VECTOR_ELT(contents, 332, ScalarInteger(internal->offset_variable_ID));
  SET_VECTOR_ELT(contents, 333, ScalarInteger(internal->offset_variable_P));
  SET_VECTOR_ELT(contents, 334, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 335, ScalarInteger(internal->offset_variable_T));
  SET_VECTOR_ELT(contents, 336, ScalarInteger(internal->offset_variable_U));
  SET_VECTOR_ELT(contents, 337, ScalarReal(internal->omega));
  SEXP p_det = PROTECT(allocVector(REALSXP, internal->dim_p_det));
  memcpy(REAL(p_det), internal->p_det, internal->dim_p_det * sizeof(double));
  odin_set_dim(p_det, 3, internal->dim_p_det_1, internal->dim_p_det_2, internal->dim_p_det_3);
  SET_VECTOR_ELT(contents, 338, p_det);
  SET_VECTOR_ELT(contents, 339, ScalarReal(internal->p10));
  SET_VECTOR_ELT(contents, 340, ScalarReal(internal->p2));
  SEXP phi = PROTECT(allocVector(REALSXP, internal->dim_phi));
  memcpy(REAL(phi), internal->phi, internal->dim_phi * sizeof(double));
  odin_set_dim(phi, 3, internal->dim_phi_1, internal->dim_phi_2, internal->dim_phi_3);
  SET_VECTOR_ELT(contents, 341, phi);
  SET_VECTOR_ELT(contents, 342, ScalarReal(internal->phi0));
  SET_VECTOR_ELT(contents, 343, ScalarReal(internal->phi1));
  SET_VECTOR_ELT(contents, 344, ScalarReal(internal->pi));
  SET_VECTOR_ELT(contents, 345, ScalarReal(internal->PM));
  SEXP prev0to59 = PROTECT(allocVector(REALSXP, internal->dim_prev0to59));
  memcpy(REAL(prev0to59), internal->prev0to59, internal->dim_prev0to59 * sizeof(double));
  odin_set_dim(prev0to59, 3, internal->dim_prev0to59_1, internal->dim_prev0to59_2, internal->dim_prev0to59_3);
  SET_VECTOR_ELT(contents, 346, prev0to59);
  SET_VECTOR_ELT(contents, 347, ScalarReal(internal->Q0));
  SET_VECTOR_ELT(contents, 348, ScalarReal(internal->r_IRS0));
  SET_VECTOR_ELT(contents, 349, ScalarReal(internal->r_ITN0));
  SET_VECTOR_ELT(contents, 350, ScalarReal(internal->r_ITN1));
  SET_VECTOR_ELT(contents, 351, ScalarReal(internal->rA));
  SET_VECTOR_ELT(contents, 352, ScalarReal(internal->rD));
  SEXP rel_foi = PROTECT(allocVector(REALSXP, internal->dim_rel_foi));
  memcpy(REAL(rel_foi), internal->rel_foi, internal->dim_rel_foi * sizeof(double));
  SET_VECTOR_ELT(contents, 353, rel_foi);
  SET_VECTOR_ELT(contents, 354, ScalarReal(internal->rP));
  SET_VECTOR_ELT(contents, 355, ScalarReal(internal->rT));
  SET_VECTOR_ELT(contents, 356, ScalarReal(internal->rU));
  SET_VECTOR_ELT(contents, 357, ScalarReal(internal->ssa0));
  SET_VECTOR_ELT(contents, 358, ScalarReal(internal->ssa1));
  SET_VECTOR_ELT(contents, 359, ScalarReal(internal->ssa2));
  SET_VECTOR_ELT(contents, 360, ScalarReal(internal->ssa3));
  SET_VECTOR_ELT(contents, 361, ScalarReal(internal->ssb1));
  SET_VECTOR_ELT(contents, 362, ScalarReal(internal->ssb2));
  SET_VECTOR_ELT(contents, 363, ScalarReal(internal->ssb3));
  SET_VECTOR_ELT(contents, 364, ScalarReal(internal->tau1));
  SET_VECTOR_ELT(contents, 365, ScalarReal(internal->tau2));
  SET_VECTOR_ELT(contents, 366, ScalarReal(internal->theta_c));
  SET_VECTOR_ELT(contents, 367, ScalarReal(internal->uB));
  SET_VECTOR_ELT(contents, 368, ScalarReal(internal->uCA));
  SET_VECTOR_ELT(contents, 369, ScalarReal(internal->uD));
  SEXP w = PROTECT(allocVector(REALSXP, internal->dim_w));
  memcpy(REAL(w), internal->w, internal->dim_w * sizeof(double));
  SET_VECTOR_ELT(contents, 370, w);
  SEXP w_ = PROTECT(allocVector(REALSXP, internal->dim_w_));
  memcpy(REAL(w_), internal->w_, internal->dim_w_ * sizeof(double));
  SET_VECTOR_ELT(contents, 371, w_);
  SEXP whi = PROTECT(allocVector(REALSXP, internal->dim_whi));
  memcpy(REAL(whi), internal->whi, internal->dim_whi * sizeof(double));
  SET_VECTOR_ELT(contents, 372, whi);
  SEXP x_I = PROTECT(allocVector(REALSXP, internal->dim_x_I));
  memcpy(REAL(x_I), internal->x_I, internal->dim_x_I * sizeof(double));
  SET_VECTOR_ELT(contents, 373, x_I);
  SEXP Y = PROTECT(allocVector(REALSXP, internal->dim_Y));
  memcpy(REAL(Y), internal->Y, internal->dim_Y * sizeof(double));
  odin_set_dim(Y, 3, internal->dim_Y_1, internal->dim_Y_2, internal->dim_Y_3);
  SET_VECTOR_ELT(contents, 374, Y);
  SEXP yy = PROTECT(allocVector(REALSXP, internal->dim_yy));
  memcpy(REAL(yy), internal->yy, internal->dim_yy * sizeof(double));
  SET_VECTOR_ELT(contents, 375, yy);
  SEXP yy_ = PROTECT(allocVector(REALSXP, internal->dim_yy_));
  memcpy(REAL(yy_), internal->yy_, internal->dim_yy_ * sizeof(double));
  SET_VECTOR_ELT(contents, 376, yy_);
  SEXP z = PROTECT(allocVector(REALSXP, internal->dim_z));
  memcpy(REAL(z), internal->z, internal->dim_z * sizeof(double));
  SET_VECTOR_ELT(contents, 377, z);
  SEXP z_ = PROTECT(allocVector(REALSXP, internal->dim_z_));
  memcpy(REAL(z_), internal->z_, internal->dim_z_ * sizeof(double));
  SET_VECTOR_ELT(contents, 378, z_);
  SEXP zhi = PROTECT(allocVector(REALSXP, internal->dim_zhi));
  memcpy(REAL(zhi), internal->zhi, internal->dim_zhi * sizeof(double));
  SET_VECTOR_ELT(contents, 379, zhi);
  SET_VECTOR_ELT(contents, 380, ScalarLogical(internal->odin_model_hrp2_use_dde));
  SEXP nms = PROTECT(allocVector(STRSXP, 381));
  SET_STRING_ELT(nms, 0, mkChar("aD"));
  SET_STRING_ELT(nms, 1, mkChar("age"));
  SET_STRING_ELT(nms, 2, mkChar("age_20_factor"));
  SET_STRING_ELT(nms, 3, mkChar("age_rate"));
  ...
  SET_STRING_ELT(nms, 105, mkChar("dim_Ev"));
  SET_STRING_ELT(nms, 106, mkChar("dim_fd"));
  SET_STRING_ELT(nms, 107, mkChar("dim_FOI"));
  SET_STRING_ELT(nms, 108, mkChar("dim_FOI_1"));
  SET_STRING_ELT(nms, 109, mkChar("dim_FOI_12"));
  SET_STRING_ELT(nms, 110, mkChar("dim_FOI_2"));
  SET_STRING_ELT(nms, 111, mkChar("dim_FOI_3"));
  SET_STRING_ELT(nms, 112, mkChar("dim_foi_age"));
  SET_STRING_ELT(nms, 113, mkChar("dim_FOI_lag"));
  SET_STRING_ELT(nms, 114, mkChar("dim_FOI_lag_1"));
  SET_STRING_ELT(nms, 115, mkChar("dim_FOI_lag_12"));
  SET_STRING_ELT(nms, 116, mkChar("dim_FOI_lag_2"));
  SET_STRING_ELT(nms, 117, mkChar("dim_FOI_lag_3"));
  SET_STRING_ELT(nms, 118, mkChar("dim_FOIvijk"));
  SET_STRING_ELT(nms, 119, mkChar("dim_FOIvijk_1"));
  SET_STRING_ELT(nms, 120, mkChar("dim_FOIvijk_12"));
  SET_STRING_ELT(nms, 121, mkChar("dim_FOIvijk_2"));
  SET_STRING_ELT(nms, 122, mkChar("dim_FOIvijk_3"));
  SET_STRING_ELT(nms, 123, mkChar("dim_het_wt"));
  SET_STRING_ELT(nms, 124, mkChar("dim_IB"));
  SET_STRING_ELT(nms, 125, mkChar("dim_IB_1"));
  SET_STRING_ELT(nms, 126, mkChar("dim_IB_12"));
  SET_STRING_ELT(nms, 127, mkChar("dim_IB_2"));
  SET_STRING_ELT(nms, 128, mkChar("dim_IB_3"));
  SET_STRING_ELT(nms, 129, mkChar("dim_IC"));
  SET_STRING_ELT(nms, 130, mkChar("dim_IC_1"));
  SET_STRING_ELT(nms, 131, mkChar("dim_IC_12"));
  SET_STRING_ELT(nms, 132, mkChar("dim_IC_2"));
  SET_STRING_ELT(nms, 133, mkChar("dim_IC_3"));
  SET_STRING_ELT(nms, 134, mkChar("dim_ICA"));
  SET_STRING_ELT(nms, 135, mkChar("dim_ICA_1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_ICA_12"));
  SET_STRING_ELT(nms, 137, mkChar("dim_ICA_2"));
  SET_STRING_ELT(nms, 138, mkChar("dim_ICA_3"));
  SET_STRING_ELT(nms, 139, mkChar("dim_ICM"));
  SET_STRING_ELT(nms, 140, mkChar("dim_ICM_1"));
  SET_STRING_ELT(nms, 141, mkChar("dim_ICM_12"));
  SET_STRING_ELT(nms, 142, mkChar("dim_ICM_2"));
  SET_STRING_ELT(nms, 143, mkChar("dim_ICM_3"));
  SET_STRING_ELT(nms, 144, mkChar("dim_ID"));
  SET_STRING_ELT(nms, 145, mkChar("dim_ID_1"));
  SET_STRING_ELT(nms, 146, mkChar("dim_ID_12"));
  SET_STRING_ELT(nms, 147, mkChar("dim_ID_2"));
  SET_STRING_ELT(nms, 148, mkChar("dim_ID_3"));
  SET_STRING_ELT(nms, 149, mkChar("dim_init_A"));
  SET_STRING_ELT(nms, 150, mkChar("dim_init_A_1"));
  SET_STRING_ELT(nms, 151, mkChar("dim_init_A_12"));
  SET_STRING_ELT(nms, 152, mkChar("dim_init_A_2"));
  SET_STRING_ELT(nms, 153, mkChar("dim_init_A_3"));
  SET_STRING_ELT(nms, 154, mkChar("dim_init_D"));
  SET_STRING_ELT(nms, 155, mkChar("dim_init_D_1"));
  SET_STRING_ELT(nms, 156, mkChar("dim_init_D_12"));
  SET_STRING_ELT(nms, 157, mkChar("dim_init_D_2"));
  SET_STRING_ELT(nms, 158, mkChar("dim_init_D_3"));
  SET_STRING_ELT(nms, 159, mkChar("dim_init_IB"));
  SET_STRING_ELT(nms, 160, mkChar("dim_init_IB_1"));
  SET_STRING_ELT(nms, 161, mkChar("dim_init_IB_12"));
  SET_STRING_ELT(nms, 162, mkChar("dim_init_IB_2"));
  SET_STRING_ELT(nms, 163, mkChar("dim_init_IB_3"));
  SET_STRING_ELT(nms, 164, mkChar("dim_init_ICA"));
  SET_STRING_ELT(nms, 165, mkChar("dim_init_ICA_1"));
  SET_STRING_ELT(nms, 166, mkChar("dim_init_ICA_12"));
  SET_STRING_ELT(nms, 167, mkChar("dim_init_ICA_2"));
  SET_STRING_ELT(nms, 168, mkChar("dim_init_ICA_3"));
  SET_STRING_ELT(nms, 169, mkChar("dim_init_ICM"));
  SET_STRING_ELT(nms, 170, mkChar("dim_init_ICM_1"));
  SET_STRING_ELT(nms, 171, mkChar("dim_init_ICM_12"));
  SET_STRING_ELT(nms, 172, mkChar("dim_init_ICM_2"));
  SET_STRING_ELT(nms, 173, mkChar("dim_init_ICM_3"));
  SET_STRING_ELT(nms, 174, mkChar("dim_init_ICM_pre"));
  SET_STRING_ELT(nms, 175, mkChar("dim_init_ICM_pre_1"));
  SET_STRING_ELT(nms, 176, mkChar("dim_init_ICM_pre_2"));
  SET_STRING_ELT(nms, 177, mkChar("dim_init_ID"));
  SET_STRING_ELT(nms, 178, mkChar("dim_init_ID_1"));
  SET_STRING_ELT(nms, 179, mkChar("dim_init_ID_12"));
  SET_STRING_ELT(nms, 180, mkChar("dim_init_ID_2"));
  SET_STRING_ELT(nms, 181, mkChar("dim_init_ID_3"));
  SET_STRING_ELT(nms, 182, mkChar("dim_init_P"));
  SET_STRING_ELT(nms, 183, mkChar("dim_init_P_1"));
  SET_STRING_ELT(nms, 184, mkChar("dim_init_P_12"));
  SET_STRING_ELT(nms, 185, mkChar("dim_init_P_2"));
  SET_STRING_ELT(nms, 186, mkChar("dim_init_P_3"));
  SET_STRING_ELT(nms, 187, mkChar("dim_init_S"));
  SET_STRING_ELT(nms, 188, mkChar("dim_init_S_1"));
  SET_STRING_ELT(nms, 189, mkChar("dim_init_S_12"));
  SET_STRING_ELT(nms, 190, mkChar("dim_init_S_2"));
  SET_STRING_ELT(nms, 191, mkChar("dim_init_S_3"));
  SET_STRING_ELT(nms, 192, mkChar("dim_init_T"));
  SET_STRING_ELT(nms, 193, mkChar("dim_init_T_1"));
  SET_STRING_ELT(nms, 194, mkChar("dim_init_T_12"));
  SET_STRING_ELT(nms, 195, mkChar("dim_init_T_2"));
  SET_STRING_ELT(nms, 196, mkChar("dim_init_T_3"));
  SET_STRING_ELT(nms, 197, mkChar("dim_init_U"));
  SET_STRING_ELT(nms, 198, mkChar("dim_init_U_1"));
  SET_STRING_ELT(nms, 199, mkChar("dim_init_U_12"));
  SET_STRING_ELT(nms, 200, mkChar("dim_init_U_2"));
  SET_STRING_ELT(nms, 201, mkChar("dim_init_U_3"));
  SET_STRING_ELT(nms, 202, mkChar("dim_P"));
  SET_STRING_ELT(nms, 203, mkChar("dim_P_1"));
  SET_STRING_ELT(nms, 204, mkChar("dim_P_12"));
  SET_STRING_ELT(nms, 205, mkChar("dim_P_2"));
  SET_STRING_ELT(nms, 206, mkChar("dim_P_3"));
  SET_STRING_ELT(nms, 207, mkChar("dim_p_det"));
  SET_STRING_ELT(nms, 208, mkChar("dim_p_det_1"));
  SET_STRING_ELT(nms, 209, mkChar("dim_p_det_12"));
  SET_STRING_ELT(nms, 210, mkChar("dim_p_det_2"));
  SET_STRING_ELT(nms, 211, mkChar("dim_p_det_3"));
  SET_STRING_ELT(nms, 212, mkChar("dim_phi"));
  SET_STRING_ELT(nms, 213, mkChar("dim_phi_1"));
  SET_STRING_ELT(nms, 214, mkChar("dim_phi_12"));
  SET_STRING_ELT(nms, 215, mkChar("dim_phi_2"));
  SET_STRING_ELT(nms, 216, mkChar("dim_phi_3"));
  SET_STRING_ELT(nms, 217, mkChar("dim_prev0to59"));
  SET_STRING_ELT(nms, 218, mkChar("dim_prev0to59_1"));
  SET_STRING_ELT(nms, 219, mkChar("dim_prev0to59_12"));
  SET_STRING_ELT(nms, 220, mkChar("dim_prev0to59_2"));
  SET_STRING_ELT(nms, 221, mkChar("dim_prev0to59_3"));
  SET_STRING_ELT(nms, 222, mkChar("dim_rel_foi"));
  SET_STRING_ELT(nms, 223, mkChar("dim_S"));
  SET_STRING_ELT(nms, 224, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 225, mkChar("dim_S_12"));
  SET_STRING_ELT(nms, 226, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 227, mkChar("dim_S_3"));
  SET_STRING_ELT(nms, 228, mkChar("dim_T"));
  SET_STRING_ELT(nms, 229, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 230, mkChar("dim_T_12"));
  SET_STRING_ELT(nms, 231, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 232, mkChar("dim_T_3"));
  SET_STRING_ELT(nms, 233, mkChar("dim_U"));
  SET_STRING_ELT(nms, 234, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 235, mkChar("dim_U_12"));
  SET_STRING_ELT(nms, 236, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 237, mkChar("dim_U_3"));
  SET_STRING_ELT(nms, 238, mkChar("dim_w"));
  SET_STRING_ELT(nms, 239, mkChar("dim_w_"));
  SET_STRING_ELT(nms, 240, mkChar("dim_whi"));
  SET_STRING_ELT(nms, 241, mkChar("dim_x_I"));
  SET_STRING_ELT(nms, 242, mkChar("dim_Y"));
  SET_STRING_ELT(nms, 243, mkChar("dim_Y_1"));
  SET_STRING_ELT(nms, 244, mkChar("dim_Y_12"));
  SET_STRING_ELT(nms, 245, mkChar("dim_Y_2"));
  SET_STRING_ELT(nms, 246, mkChar("dim_Y_3"));
  SET_STRING_ELT(nms, 247, mkChar("dim_yy"));
  SET_STRING_ELT(nms, 248, mkChar("dim_yy_"));
  SET_STRING_ELT(nms, 249, mkChar("dim_z"));
  SET_STRING_ELT(nms, 250, mkChar("dim_z_"));
  SET_STRING_ELT(nms, 251, mkChar("dim_zhi"));
  SET_STRING_ELT(nms, 252, mkChar("dLL"));
  SET_STRING_ELT(nms, 253, mkChar("dPL"));
  SET_STRING_ELT(nms, 254, mkChar("EIR"));
  SET_STRING_ELT(nms, 255, mkChar("eta"));
  SET_STRING_ELT(nms, 256, mkChar("fd"));
  SET_STRING_ELT(nms, 257, mkChar("fD0"));
  SET_STRING_ELT(nms, 258, mkChar("FOI"));
  SET_STRING_ELT(nms, 259, mkChar("foi_age"));
  SET_STRING_ELT(nms, 260, mkChar("FOI_lag"));
  SET_STRING_ELT(nms, 261, mkChar("FOIvijk"));
  SET_STRING_ELT(nms, 262, mkChar("ft"));
  SET_STRING_ELT(nms, 263, mkChar("gamma1"));
  SET_STRING_ELT(nms, 264, mkChar("gammaD"));
  SET_STRING_ELT(nms, 265, mkChar("gammaL"));
  SET_STRING_ELT(nms, 266, mkChar("het_wt"));
  SET_STRING_ELT(nms, 267, mkChar("hrp2_prop"));
  SET_STRING_ELT(nms, 268, mkChar("IB0"));
  SET_STRING_ELT(nms, 269, mkChar("IC"));
  SET_STRING_ELT(nms, 270, mkChar("IC0"));
  SET_STRING_ELT(nms, 271, mkChar("ID0"));
  SET_STRING_ELT(nms, 272, mkChar("init_A"));
  SET_STRING_ELT(nms, 273, mkChar("init_D"));
  SET_STRING_ELT(nms, 274, mkChar("init_EL"));
  SET_STRING_ELT(nms, 275, mkChar("init_Ev"));
  SET_STRING_ELT(nms, 276, mkChar("init_IB"));
  SET_STRING_ELT(nms, 277, mkChar("init_ICA"));
  SET_STRING_ELT(nms, 278, mkChar("init_ICM"));
  SET_STRING_ELT(nms, 279, mkChar("init_ICM_pre"));
  SET_STRING_ELT(nms, 280, mkChar("init_ID"));
  SET_STRING_ELT(nms, 281, mkChar("init_Iv"));
  SET_STRING_ELT(nms, 282, mkChar("init_LL"));
  SET_STRING_ELT(nms, 283, mkChar("init_P"));
  SET_STRING_ELT(nms, 284, mkChar("init_PL"));
  SET_STRING_ELT(nms, 285, mkChar("init_S"));
  SET_STRING_ELT(nms, 286, mkChar("init_Sv"));
  SET_STRING_ELT(nms, 287, mkChar("init_T"));
  SET_STRING_ELT(nms, 288, mkChar("init_U"));
  SET_STRING_ELT(nms, 289, mkChar("initial_A"));
  SET_STRING_ELT(nms, 290, mkChar("initial_D"));
  SET_STRING_ELT(nms, 291, mkChar("initial_EL"));
  SET_STRING_ELT(nms, 292, mkChar("initial_Ev"));
  SET_STRING_ELT(nms, 293, mkChar("initial_IB"));
  SET_STRING_ELT(nms, 294, mkChar("initial_ICA"));
  SET_STRING_ELT(nms, 295, mkChar("initial_ICM"));
  SET_STRING_ELT(nms, 296, mkChar("initial_ID"));
  SET_STRING_ELT(nms, 297, mkChar("initial_Iv"));
  SET_STRING_ELT(nms, 298, mkChar("initial_LL"));
  SET_STRING_ELT(nms, 299, mkChar("initial_P"));
  SET_STRING_ELT(nms, 300, mkChar("initial_PL"));
  SET_STRING_ELT(nms, 301, mkChar("initial_S"));
  SET_STRING_ELT(nms, 302, mkChar("initial_Sv"));
  SET_STRING_ELT(nms, 303, mkChar("initial_t"));
  SET_STRING_ELT(nms, 304, mkChar("initial_T"));
  SET_STRING_ELT(nms, 305, mkChar("initial_U"));
  SET_STRING_ELT(nms, 306, mkChar("irs_cov"));
  SET_STRING_ELT(nms, 307, mkChar("IRS_interval"));
  SET_STRING_ELT(nms, 308, mkChar("irs_loss"));
  SET_STRING_ELT(nms, 309, mkChar("itn_cov"));
  SET_STRING_ELT(nms, 310, mkChar("ITN_interval"));
  SET_STRING_ELT(nms, 311, mkChar("ITN_IRS_on"));
  SET_STRING_ELT(nms, 312, mkChar("itn_loss"));
  SET_STRING_ELT(nms, 313, mkChar("kB"));
  SET_STRING_ELT(nms, 314, mkChar("kC"));
  SET_STRING_ELT(nms, 315, mkChar("kD"));
  SET_STRING_ELT(nms, 316, mkChar("mu0"));
  SET_STRING_ELT(nms, 317, mkChar("muEL"));
  SET_STRING_ELT(nms, 318, mkChar("muLL"));
  SET_STRING_ELT(nms, 319, mkChar("muPL"));
  SET_STRING_ELT(nms, 320, mkChar("mv0"));
  SET_STRING_ELT(nms, 321, mkChar("na"));
  SET_STRING_ELT(nms, 322, mkChar("nh"));
  SET_STRING_ELT(nms, 323, mkChar("num_int"));
  SET_STRING_ELT(nms, 324, mkChar("offset_FOIv_A"));
  SET_STRING_ELT(nms, 325, mkChar("offset_FOIv_ID"));
  SET_STRING_ELT(nms, 326, mkChar("offset_FOIv_U"));
  SET_STRING_ELT(nms, 327, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 328, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 329, mkChar("offset_variable_IB"));
  SET_STRING_ELT(nms, 330, mkChar("offset_variable_ICA"));
  SET_STRING_ELT(nms, 331, mkChar("offset_variable_ICM"));
  SET_STRING_ELT(nms, 332, mkChar("offset_variable_ID"));
  SET_STRING_ELT(nms, 333, mkChar("offset_variable_P"));
  SET_STRING_ELT(nms, 334, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 335, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 336, mkChar("offset_variable_U"));
  SET_STRING_ELT(nms, 337, mkChar("omega"));
  SET_STRING_ELT(nms, 338, mkChar("p_det"));
  SET_STRING_ELT(nms, 339, mkChar("p10"));
  SET_STRING_ELT(nms, 340, mkChar("p2"));
  SET_STRING_ELT(nms, 341, mkChar("phi"));
  SET_STRING_ELT(nms, 342, mkChar("phi0"));
  SET_STRING_ELT(nms, 343, mkChar("phi1"));
  SET_STRING_ELT(nms, 344, mkChar("pi"));
  SET_STRING_ELT(nms, 345, mkChar("PM"));
  SET_STRING_ELT(nms, 346, mkChar("prev0to59"));
  SET_STRING_ELT(nms, 347, mkChar("Q0"));
  SET_STRING_ELT(nms, 348, mkChar("r_IRS0"));
  SET_STRING_ELT(nms, 349, mkChar("r_ITN0"));
  SET_STRING_ELT(nms, 350, mkChar("r_ITN1"));
  SET_STRING_ELT(nms, 351, mkChar("rA"));
  SET_STRING_ELT(nms, 352, mkChar("rD"));
  SET_STRING_ELT(nms, 353, mkChar("rel_foi"));
  SET_STRING_ELT(nms, 354, mkChar("rP"));
  SET_STRING_ELT(nms, 355, mkChar("rT"));
  SET_STRING_ELT(nms, 356, mkChar("rU"));
  SET_STRING_ELT(nms, 357, mkChar("ssa0"));
  SET_STRING_ELT(nms, 358, mkChar("ssa1"));
  SET_STRING_ELT(nms, 359, mkChar("ssa2"));
  SET_STRING_ELT(nms, 360, mkChar("ssa3"));
  SET_STRING_ELT(nms, 361, mkChar("ssb1"));
  SET_STRING_ELT(nms, 362, mkChar("ssb2"));
  SET_STRING_ELT(nms, 363, mkChar("ssb3"));
  SET_STRING_ELT(nms, 364, mkChar("tau1"));
  SET_STRING_ELT(nms, 365, mkChar("tau2"));
  SET_STRING_ELT(nms, 366, mkChar("theta_c"));
  SET_STRING_ELT(nms, 367, mkChar("uB"));
  SET_STRING_ELT(nms, 368, mkChar("uCA"));
  SET_STRING_ELT(nms, 369, mkChar("uD"));
  SET_STRING_ELT(nms, 370, mkChar("w"));
  SET_STRING_ELT(nms, 371, mkChar("w_"));
  SET_STRING_ELT(nms, 372, mkChar("whi"));
  SET_STRING_ELT(nms, 373, mkChar("x_I"));
  SET_STRING_ELT(nms, 374, mkChar("Y"));
  SET_STRING_ELT(nms, 375, mkChar("yy"));
  SET_STRING_ELT(nms, 376, mkChar("yy_"));
  SET_STRING_ELT(nms, 377, mkChar("z"));
  SET_STRING_ELT(nms, 378, mkChar("z_"));
  SET_STRING_ELT(nms, 379, mkChar("zhi"));
  SET_STRING_ELT(nms, 380, mkChar("odin_model_hrp2_use_dde"));
  setAttrib(contents, R_NamesSymbol, nms);
  UNPROTECT(79);
  return contents;
}
...
SEXP odin_model_hrp2_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(22 + internal->dim_cov));
  UNPROTECT(2);
  return ret;
}
SEXP odin_model_hrp2_initial_conditions(SEXP internal_p, SEXP t_ptr) {
...
void odin_model_hrp2_rhs(odin_model_hrp2_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  double incv;
  {
    ...
    if (t <= internal->initial_t) {
      ...
      lagvalue(t, internal->odin_model_hrp2_use_dde, internal->delay_index_incv, internal->dim_delay_incv, internal->delay_state_incv);
      Sv = internal->delay_state_incv[0];
    }
    double ITN_decay = (t < internal->ITN_IRS_on ? 0 : exp(-((fmodr((t - internal->ITN_IRS_on), internal->ITN_interval))) * internal->itn_loss));
    double IRS_decay = (t < internal->ITN_IRS_on ? 0 : exp(-((fmodr((t - internal->ITN_IRS_on), internal->IRS_interval))) * internal->irs_loss));
...
SEXP odin_model_hrp2_rhs_r(SEXP internal_p, SEXP t, SEXP state) {
  SEXP dstatedt = PROTECT(allocVector(REALSXP, LENGTH(state)));
  odin_model_hrp2_internal *internal = odin_model_hrp2_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, 22 + internal->dim_cov));
  setAttrib(dstatedt, install("output"), output_ptr);
  UNPROTECT(1);
  double *output = REAL(output_ptr);
  const double initial_t = internal->initial_t;
...
SEXP odin_model_IVM_SMChet_create(SEXP user) {
  ...
  Free(internal->initial_Ev);
  internal->initial_Ev = (double*) Calloc(internal->dim_Ev, double);
  internal->offset_variable_Sx = 5 + internal->dim_Ev;
  internal->aD = NA_REAL;
  internal->age = NULL;
  internal->age_rate = NULL;
...
SEXP odin_model_IVM_SMChet_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->offset_FOI_IB = 1 + internal->dim_Ix;
  internal->offset_variable_Ex = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix;
  internal->offset_variable_Ix = 5 + internal->dim_Ev + internal->dim_Sx;
  internal->rel_foi = (double*) user_get_array(user, false, internal->rel_foi, "rel_foi", NA_REAL, NA_REAL, 1, internal->dim_rel_foi);
  internal->x_I = (double*) user_get_array(user, false, internal->x_I, "x_I", NA_REAL, NA_REAL, 1, internal->dim_x_I);
  Free(internal->b);
  internal->b = (double*) Calloc(internal->dim_b, double);
  ...
  Free(internal->delay_array_p_det);
  internal->delay_array_p_det = (double*) Calloc(internal->dim_p_det, double);
  internal->dim_delay_FOI = 1 + internal->dim_Ix + internal->dim_IB;
  internal->dim_delay_FOIv = internal->dim_T + internal->dim_D + internal->dim_A + internal->dim_U + internal->dim_ID;
  for (int i = 1; i <= internal->na; ++i) {
    internal->fd[i - 1] = 1 - (1 - internal->fD0) / (double) (1 + pow((internal->age[i - 1] / (double) internal->aD), internal->gammaD));
  }
  ...
  internal->offset_FOIv_ID = internal->dim_T + internal->dim_D + internal->dim_A + internal->dim_U;
  internal->offset_FOIv_U = internal->dim_T + internal->dim_D + internal->dim_A;
  internal->offset_variable_A = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex + internal->dim_S + internal->dim_T + internal->dim_D;
  internal->offset_variable_D = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex + internal->dim_S + internal->dim_T;
  internal->offset_variable_IB = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex + internal->dim_S + internal->dim_T + internal->dim_D + internal->dim_A + internal->dim_U + internal->dim_P + internal->dim_ICM + internal->dim_ICA;
  internal->offset_variable_ICA = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex + internal->dim_S + internal->dim_T + internal->dim_D + internal->dim_A + internal->dim_U + internal->dim_P + internal->dim_ICM;
  internal->offset_variable_ICM = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex + internal->dim_S + internal->dim_T + internal->dim_D + internal->dim_A + internal->dim_U + internal->dim_P;
  internal->offset_variable_ID = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex + internal->dim_S + internal->dim_T + internal->dim_D + internal->dim_A + internal->dim_U + internal->dim_P + internal->dim_ICM + internal->dim_ICA + internal->dim_IB;
  internal->offset_variable_P = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex + internal->dim_S + internal->dim_T + internal->dim_D + internal->dim_A + internal->dim_U;
  internal->offset_variable_S = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex;
  internal->offset_variable_T = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex + internal->dim_S;
  internal->offset_variable_U = 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex + internal->dim_S + internal->dim_T + internal->dim_D + internal->dim_A;
  Free(internal->delay_index_FOI);
  internal->delay_index_FOI = Calloc(internal->dim_delay_FOI, int);
  Free(internal->delay_state_FOI);
  internal->delay_state_FOI = Calloc(internal->dim_delay_FOI, double);
...
SEXP odin_model_IVM_SMChet_initial_conditions(SEXP internal_p, SEXP t_ptr) {
  double t = scalar_real(t_ptr, "t");
  odin_model_IVM_SMChet_internal *internal = odin_model_IVM_SMChet_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, 5 + internal->dim_Ev + internal->dim_Sx + internal->dim_Ix + internal->dim_Ex + internal->dim_S + internal->dim_T + internal->dim_D + internal->dim_A + internal->dim_U + internal->dim_P + internal->dim_ICM + internal->dim_ICA + internal->dim_IB + internal->dim_ID));
  double * state = REAL(r_state);
  state[0] = internal->initial_Sv;
  state[1] = internal->initial_Iv;
  state[2] = internal->initial_PL;
