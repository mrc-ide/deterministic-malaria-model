...
extern void vivax_model_initmod_desolve(void *);
extern void vivax_model_output_dde(void *);
extern void vivax_model_rhs_dde(void *);
extern void vivax_model_rhs_desolve(void *);
...
extern SEXP vivax_model_contents(SEXP);
extern SEXP vivax_model_create(SEXP);
extern SEXP vivax_model_initial_conditions(SEXP, SEXP);
extern SEXP vivax_model_metadata(SEXP);
extern SEXP vivax_model_rhs_r(SEXP, SEXP, SEXP);
extern SEXP vivax_model_set_initial(SEXP, SEXP, SEXP, SEXP);
extern SEXP vivax_model_set_user(SEXP, SEXP);
...
static const R_CMethodDef CEntries[] = {
    ...
    {"vivax_model_initmod_desolve",           (DL_FUNC) &vivax_model_initmod_desolve,           1},
    {"vivax_model_output_dde",                (DL_FUNC) &vivax_model_output_dde,                1},
    {"vivax_model_rhs_dde",                   (DL_FUNC) &vivax_model_rhs_dde,                   1},
    {"vivax_model_rhs_desolve",               (DL_FUNC) &vivax_model_rhs_desolve,               1},
    {NULL, NULL, 0}
};
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"vivax_model_contents",                     (DL_FUNC) &vivax_model_contents,                     1},
    {"vivax_model_create",                       (DL_FUNC) &vivax_model_create,                       1},
    {"vivax_model_initial_conditions",           (DL_FUNC) &vivax_model_initial_conditions,           2},
    {"vivax_model_metadata",                     (DL_FUNC) &vivax_model_metadata,                     1},
    {"vivax_model_rhs_r",                        (DL_FUNC) &vivax_model_rhs_r,                        3},
    {"vivax_model_set_initial",                  (DL_FUNC) &vivax_model_set_initial,                  4},
    {"vivax_model_set_user",                     (DL_FUNC) &vivax_model_set_user,                     2},
    {NULL, NULL, 0}
};
