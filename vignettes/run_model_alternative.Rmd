...
## Emanator model
To run the version of the malaria model that has emanators in instead of IRS (see emanator modelling paper), several further parameter values need to be specified when calling `run_model`:
