...
If you write some new code in a file called `example_model.R`, you should save it in `inst/odin` with the other models. You then need to run `odin::odin_package`, this will add a compiled version of your odin model to the package files. 
